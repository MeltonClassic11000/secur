...
! function(e, t) {
    ...
    var s, r, o = function(e) {
        ...
        d = function(e) {
            ...
            return s || r ? (i = i.split(",")[0], n = n.split(",")[0], 1e3 * (Number.parseFloat(i) + Number.parseFloat(n))) : 0
        },
        u = function(e) {
        ...
        h = function(e, t, i) {
            Object.keys(i).forEach((function(n) {
                var s, r = i[n],
                    o = t[n],
                    a = o && p(o) ? "element" : null == (s = o) ? "" + s : {}.toString.call(s).match(/\s([a-z]+)/i)[1].toLowerCase();
    ...
    function z(e, t, i) {
        var n = "string" == typeof t,
            ...
            r = e.replace(T, ""),
            o = I[r];
        return o && (r = o), A.has(r) || (r = e), [n, s, r]
    }
    ...
    function D(e, t, i, n, s) {
        if ("string" == typeof t && e) {
            ...
            if (u) u.oneOff = u.oneOff && s;
                ...
                var p = P(a, t.replace(S, "")),
                    f = o ? function(e, t, i) {
                        return function n(s) {
                            for (var r = e.querySelectorAll(t), o = s.target; o && o !== this; o = o.parentNode)
                                for (var a = r.length; a--;)
                                    if (r[a] === o) return s.delegateTarget = o, n.oneOff && $.off(e, s.type, i), i.apply(o, [s]);
                            return null
                        }
                    }(e, i, n) : function(e, t) {
                        return function i(n) {
                ...
                f.delegationSelector = o ? i : null, f.originalHandler = a, f.oneOff = s, f.uidEvent = p, d[p] = f, e.addEventListener(l, f, o)
            }
        }
    }
                ...
                if ("string" == typeof t && e) {
                    ...
                    if (void 0 === o) {
                        d && Object.keys(c).forEach((function(i) {
                            ! function(e, t, i, n) {
                                ...
                                Object.keys(s).forEach((function(r) {
                                    if (r.includes(n)) {
                                        var o = s[r];
                                        j(e, t, i, o.originalHandler, o.delegationSelector)
                                    }
                                }))
                            }(e, c, i, t.slice(1))
                        }));
                        ...
                        Object.keys(u).forEach((function(i) {
                            ...
                            if (!l || t.includes(n)) {
                                var s = u[i];
                                j(e, c, a, s.originalHandler, s.delegationSelector)
                            }
                        }))
                    } else {
                        if (!c || !c[a]) return;
    ...
    $.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', B.handleDismiss(new B)), b((function() {
        var e = y();
        if (e) {
            var t = e.fn[H];
            e.fn[H] = B.jQueryInterface, e.fn[H].Constructor = B, e.fn[H].noConflict = function() {
                return e.fn[H] = t, B.jQueryInterface
            }
        }
    }));
    var W = function(e) {
    ...
    $.on(document, "click.bs.button.data-api", '[data-bs-toggle="button"]', (function(e) {
        ...
        var t = e.target.closest('[data-bs-toggle="button"]'),
            i = x(t, "bs.button");
        i || (i = new W(t)), i.toggle()
    })), b((function() {
        var e = y();
        if (e) {
            var t = e.fn.button;
            e.fn.button = W.jQueryInterface, e.fn.button.Constructor = W, e.fn.button.noConflict = function() {
                return e.fn.button = t, W.jQueryInterface
            }
        }
    }));
    var q = {
            ...
            getDataAttribute: function(e, t) {
                return R(e.getAttribute("data-bs-" + F(t)))
            },
            offset: function(e) {
        ...
        Q = function(e) {
            ...
            return r.next = function() {
                ...
                var i, n, s, r = this,
                    o = Y.findOne(".active.carousel-item", this._element),
                    a = this._getItemIndex(o),
                    l = t || o && this._getItemByDirection(e, o),
                    c = this._getItemIndex(l),
                    u = Boolean(this._interval);
                if ("next" === e ? (i = "carousel-item-start", n = "carousel-item-next", s = "left") : (i = "carousel-item-end", n = "carousel-item-prev", s = "right"), l && l.classList.contains("active")) this._isSliding = !1;
                    ...
                    if (this._isSliding = !0, u && this.pause(), this._setActiveIndicatorElement(l), this._activeElement = l, this._element.classList.contains("slide")) {
                        ...
                        $.one(o, "transitionend", (function() {
                            l.classList.remove(i, n), l.classList.add("active"), o.classList.remove("active", n, i), r._isSliding = !1, setTimeout((function() {
                                $.trigger(r._element, "slid.bs.carousel", {
                                    relatedTarget: l,
                                    direction: s,
                                    from: a,
                                    to: c
                    ...
                    } else o.classList.remove("active"), l.classList.add("active"), this._isSliding = !1, $.trigger(this._element, "slid.bs.carousel", {
                        relatedTarget: l,
                        direction: s,
                        from: a,
                        to: c
                ...
                var n = x(e, "bs.carousel"),
                    r = i({}, X, q.getDataAttributes(e));
                ...
                if (t && t.classList.contains("carousel")) {
                    ...
                    r && (n.interval = !1), s.carouselInterface(t, n), r && x(t, "bs.carousel").to(r), e.preventDefault()
                }
            }, t(s, null, [{
                key: "Default",
                get: function() {
    ...
    $.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", Q.dataApiClickHandler), $.on(window, "load.bs.carousel.data-api", (function() {
        for (var e = Y.find('[data-bs-ride="carousel"]'), t = 0, i = e.length; t < i; t++) Q.carouselInterface(e[t], x(e[t], "bs.carousel"))
    })), b((function() {
        var e = y();
        if (e) {
            var t = e.fn[G];
            ...
            return r.toggle = function() {
                ...
                if (!this._isTransitioning && !this._element.classList.contains("show")) {
                    ...
                    if (t) {
                        ...
                        if ((i = r ? x(r, "bs.collapse") : null) && i._isTransitioning) return
                    }
                    if (!$.trigger(this._element, "show.bs.collapse").defaultPrevented) {
                        t && t.forEach((function(e) {
                            n !== e && s.collapseInterface(e, "hide"), i || _(e, "bs.collapse", null)
                        }));
                        var o = this._getDimension();
                        this._element.classList.remove("collapse"), this._element.classList.add("collapsing"), this._element.style[o] = 0, this._triggerArray.length && this._triggerArray.forEach((function(e) {
                        ...
                        })), f(this._element, l), this._element.style[o] = this._element[a] + "px"
                    }
                }
            }, r.hide = function() {
                var e = this;
                ...
                return (e = i({}, Z, e)).toggle = Boolean(e.toggle), h(K, e, J), e
                ...
                var n = x(e, "bs.collapse"),
                    r = i({}, Z, q.getDataAttributes(e), "object" == typeof t && t ? t : {});
                if (!n && r.toggle && "string" == typeof t && /show|hide/.test(t) && (r.toggle = !1), n || (n = new s(e, r)), "string" == typeof t) {
        ...
        fn: function(e) {
            ...
            Object.keys(t.elements).forEach((function(e) {
                var i = t.styles[e] || {},
                    n = t.attributes[e] || {},
                    s = t.elements[e];
                pe(s) && ce(s) && (Object.assign(s.style, i), Object.keys(n).forEach((function(e) {
                    var t = n[e];
            ...
            return Object.assign(t.elements.popper.style, i.popper), t.elements.arrow && Object.assign(t.elements.arrow.style, i.arrow),
                function() {
                    Object.keys(t.elements).forEach((function(e) {
                        ...
                        pe(n) && ce(n) && (Object.assign(n.style, r), Object.keys(s).forEach((function(e) {
                            n.removeAttribute(e)
                        })))
                    }))
                }
    ...
    function _e(e) {
        for (var t = de(e), i = Ee(e); i && ye(i) && "static" === ve(i).position;) i = Ee(i);
        return i && "body" === ce(i) && "static" === ve(i).position ? t : i || function(e) {
            for (var t = we(e); pe(t) && ["html", "body"].indexOf(ce(t)) < 0;) {
                var i = ve(t);
            ...
            fn: function(e) {
                ...
                if (s && r) {
                    var c = i.modifiersData[n + "#persistent"].padding,
                        ...
                        u = "y" === a ? te : se,
                        p = "y" === a ? ie : ne,
                        f = i.rects.reference[l] + i.rects.reference[a] - r[a] - i.rects.popper[l],
                        h = r[a] - i.rects.reference[a],
                        m = _e(s),
                        ...
                        E = Se(y, w, b),
                        _ = a;
                    i.modifiersData[n] = ((t = {})[_] = E, t.centerOffset = E - w, t)
                }
            },
            effect: function(e) {
                var t = e.state,
                    ...
                    o = i.padding,
                    a = void 0 === o ? 0 : o;
                null != r && ("string" != typeof r || (r = t.elements.popper.querySelector(r))) && ge(t.elements.popper, r) && (t.elements.arrow = r, t.modifiersData[n + "#persistent"] = {
                    padding: Te("number" != typeof a ? a : Ce(a, re))
                })
            },
    ...
    function Ie(e) {
        var t, i = e.popper,
            ...
            f = r.hasOwnProperty("y"),
            h = se,
            m = te,
            g = window;
        if (l) {
            var v = _e(i);
            v === de(i) && (v = be(i)), s === te && (m = ie, u -= v.clientHeight - n.height, u *= a ? 1 : -1), s === se && (h = ne, d -= v.clientWidth - n.width, d *= a ? 1 : -1)
        }
        var y, b = Object.assign({
            position: o
        }, l && Le);
        return a ? Object.assign(Object.assign({}, b), {}, ((y = {})[m] = f ? "0" : "", y[h] = p ? "0" : "", y.transform = (g.devicePixelRatio || 1) < 2 ? "translate(" + d + "px, " + u + "px)" : "translate3d(" + d + "px, " + u + "px, 0)", y)) : Object.assign(Object.assign({}, b), {}, ((t = {})[m] = f ? u + "px" : "", t[h] = p ? d + "px" : "", t.transform = "", t))
    }
    var Ae = {
            name: "computeStyles",
            enabled: !0,
            ...
            fn: function(e) {
                ...
                null != t.modifiersData.popperOffsets && (t.styles.popper = Object.assign(Object.assign({}, t.styles.popper), Ie(Object.assign(Object.assign({}, a), {}, {
                    offsets: t.modifiersData.popperOffsets,
                    position: t.options.strategy,
                    adaptive: o
                })))), null != t.modifiersData.arrow && (t.styles.arrow = Object.assign(Object.assign({}, t.styles.arrow), Ie(Object.assign(Object.assign({}, a), {}, {
    ...
    function He(e) {
        return $e(be(e)).left + Ne(e).scrollLeft
    }
    ...
    function We(e, t) {
        void 0 === t && (t = []);
        var i = function e(t) {
                return ["html", "body", "#document"].indexOf(ce(t)) >= 0 ? t.ownerDocument.body : pe(t) && Be(t) ? t : e(we(t))
            }(e),
            n = "body" === ce(i),
            s = de(i),
            r = n ? [s].concat(s.visualViewport || [], Be(i) ? i : []) : i,
            o = t.concat(r);
        return n ? o : o.concat(We(we(r)))
    }
    ...
    function Fe(e, t) {
        return "viewport" === t ? Re(function(e) {
            var t = de(e),
                i = be(e),
                n = t.visualViewport,
                s = i.clientWidth,
                ...
                o = 0,
                a = 0;
            return n && (s = n.width, r = n.height, /^((?!chrome|android).)*safasi/i.test(navigator.userAgent) || (o = n.offsetLeft, a = n.offsetTop)), {
                width: s,
                height: r,
                x: o + He(e),
                y: a
    ...
    function Ge(e, t) {
        ...
        var i = t,
            ...
            f = i.padding,
            h = void 0 === f ? 0 : f,
            m = Te("number" != typeof h ? h : Ce(h, re)),
            ...
            w = function(e, t, i) {
                var n = "clippingParents" === t ? function(e) {
                        var t = We(we(e)),
                            i = ["absolute", "fixed"].indexOf(ve(e).position) >= 0 && pe(e) ? _e(e) : e;
            ...
            x = Re(Object.assign(Object.assign({}, y), _)),
            S = "popper" === d ? x : E,
            T = {
    ...
    var Xe = {
        ...
        fn: function(e) {
            ...
            if (!t.modifiersData[n]._skip) {
                for (var s = i.mainAxis, r = void 0 === s || s, o = i.altAxis, a = void 0 === o || o, l = i.fallbackPlacements, c = i.padding, d = i.boundary, u = i.rootBoundary, p = i.altBoundary, f = i.flipVariations, h = void 0 === f || f, m = i.allowedAutoPlacements, g = t.options.placement, v = he(g), y = l || (v !== g && h ? function(e) {
                        if ("auto" === he(e)) return [];
                        var t = ze(e);
                        return [je(e), t, je(t)]
                    }(g) : [ze(g)]), b = [g].concat(y).reduce((function(e, i) {
                        return e.concat("auto" === he(i) ? function(e, t) {
                            void 0 === t && (t = {});
                            var i = t,
                                n = i.placement,
                                s = i.boundary,
                    ...
                    }), []), w = t.rects.reference, E = t.rects.popper, _ = new Map, x = !0, S = b[0], T = 0; T < b.length; T++) {
                    var C = b[T],
                        M = he(C),
                        L = "start" === qe(C),
                        I = [te, ie].indexOf(M) >= 0,
                    ...
                    var k = ze(O),
                        z = [];
                    if (r && z.push(P[M] <= 0), a && z.push(P[O] <= 0, P[k] <= 0), z.every((function(e) {
                            return e
                        }))) {
                        S = C, x = !1;
                        break
                    ...
                    o = ae.reduce((function(e, i) {
                        return e[i] = function(e, t, i) {
                            var n = he(e),
                                ...
                                o = r[0],
                                a = r[1];
                            return o = o || 0, a = (a || 0) * s, [se, ne].indexOf(n) >= 0 ? {
                                x: a,
                                y: o
                            } : {
                                x: o,
                ...
                if (_) {
                    if (r) {
                        var M = "y" === w ? te : se,
                            ...
                            B = N[L],
                            W = Se(0, x[I], $[I]),
                            R = b ? x[I] / 2 - k - W - H - T : z - W - H - T,
                            F = b ? -x[I] / 2 + k + W + B + T : D + W + B + T,
                            q = t.elements.arrow && _e(t.elements.arrow),
                            Y = q ? "y" === w ? q.clientTop || 0 : q.clientLeft || 0 : 0,
                            G = t.modifiersData.offset ? t.modifiersData.offset[t.placement][w] : 0,
                            X = _[w] + R - G - Y,
                            V = _[w] + F - G,
                            U = Se(f ? Math.min(P, X) : P, A, f ? Math.max(O, V) : O);
                        _[w] = U, C[w] = U - A
                    }
                    if (a) {
                        var Q = "x" === w ? te : se,
    ...
    function et(e, t, i) {
        ...
        return (a || !a && !i) && (("body" !== ce(t) || Be(r)) && (l = (n = t) !== de(n) && pe(n) ? {
            scrollLeft: (s = n).scrollLeft,
            scrollTop: s.scrollTop
        } : Ne(n)), pe(t) ? ((c = $e(t)).x += t.clientLeft, c.y += t.clientTop) : r && (c.x = He(r))), {
            ...
            var s, o, a = {
                ...
                d = {
                    ...
                    setOptions: function(i) {
                        u(), a.options = Object.assign(Object.assign(Object.assign({}, r), a.options), i), a.scrollParents = {
                            reference: ue(e) ? We(e) : e.contextElement ? We(e.contextElement) : [],
                            popper: We(t)
                        };
                        ...
                        }((s = [].concat(n, a.options.modifiers), o = s.reduce((function(e, t) {
                            var i = e[t.name];
    ...
    var st = nt(),
        rt = nt({
            defaultModifiers: [Oe, Ze, Ae, fe]
        }),
        ot = nt({
            defaultModifiers: [Oe, Ze, Ae, fe, Ke, Xe, Je, Me, Qe]
        }),
        at = Object.freeze({
            __proto__: null,
            popperGenerator: nt,
        ...
        dt = w ? "top-end" : "top-start",
        ut = w ? "top-start" : "top-end",
        pt = w ? "bottom-end" : "bottom-start",
        ft = w ? "bottom-start" : "bottom-end",
        ht = w ? "left-start" : "right-start",
        ...
        yt = function(e) {
            ...
            return r.toggle = function() {
                ...
                if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                    ...
                    if (!$.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                        if (!this._inNavbar) {
                            ...
                            var i = this._element;
                            "parent" === this._config.reference ? i = e : p(this._config.reference) && (i = this._config.reference, void 0 !== this._config.reference.jquery && (i = this._config.reference[0])), this._popper = ot(i, this._menu, this._getPopperConfig())
                        }
                        var n;
                ...
                return e = i({}, this.constructor.Default, q.getDataAttributes(this._element), e), h(lt, e, this.constructor.DefaultType), e
                ...
                return e.classList.contains("dropup") ? t ? ut : dt : t ? ft : pt
                ...
                if (i || (i = new s(e, "object" == typeof t ? t : null)), "string" == typeof t) {
                ...
                if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
                    for (var t = Y.find('[data-bs-toggle="dropdown"]'), i = 0, n = t.length; i < n; i++) {
                        ...
                        if (e && "click" === e.type && (a.clickEvent = e), o) {
                            var l, c = o._menu;
                            if (t[i].classList.contains("show") && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && "Tab" === e.key) && c.contains(e.target) || $.trigger(r, "hide.bs.dropdown", a).defaultPrevented)) "ontouchstart" in document.documentElement && (l = []).concat.apply(l, document.body.children).forEach((function(e) {
                                return $.off(e, "mouseover", null, (function() {}))
                            })), t[i].setAttribute("aria-expanded", "false"), o._popper && o._popper.destroy(), c.classList.remove("show"), t[i].classList.remove("show"), $.trigger(r, "hidden.bs.dropdown", a)
                        }
                    }
                ...
                if (!(/input|textarea/i.test(e.target.tagName) ? "Space" === e.key || "Escape" !== e.key && ("ArrowDown" !== e.key && "ArrowUp" !== e.key || e.target.closest(".dropdown-menu")) : !ct.test(e.key)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains("disabled"))) {
                    ...
                    if ("Escape" === e.key) return (this.matches('[data-bs-toggle="dropdown"]') ? this : Y.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(), void s.clearMenus();
                    if (i && "Space" !== e.key) {
                        var n = Y.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", t).filter(m);
                        if (n.length) {
                            var r = n.indexOf(e.target);
                            "ArrowUp" === e.key && r > 0 && r--, "ArrowDown" === e.key && r < n.length - 1 && r++, n[r = -1 === r ? 0 : r].focus()
                        }
                    } else s.clearMenus()
                }
            }, t(s, null, [{
    ...
    var bt = {
        ...
        Et = function(e) {
            ...
            return r.toggle = function(e) {
                ...
                return e = i({}, bt, e), h("modal", e, wt), e
                ...
                if (i) {
                    ...
                    $.one(this._dialog, "transitionend", s), f(this._dialog, r)
                } else s()
                ...
                if (this._isShown && this._config.backdrop) {
                    ...
                    $.one(this._backdrop, "transitionend", e), f(this._backdrop, n)
                    ...
                    if (this._element.classList.contains("fade")) {
                        ...
                        $.one(this._backdrop, "transitionend", s), f(this._backdrop, r)
                    } else s()
                } else e()
                ...
                if (this._isBodyOverflowing) {
                    Y.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach((function(t) {
                        ...
                        q.setDataAttribute(t, "padding-right", i), t.style.paddingRight = Number.parseFloat(n) + e._scrollbarWidth + "px"
                    })), Y.find(".sticky-top").forEach((function(t) {
                        var i = t.style.marginRight,
                            n = window.getComputedStyle(t)["margin-right"];
                        q.setDataAttribute(t, "margin-right", i), t.style.marginRight = Number.parseFloat(n) - e._scrollbarWidth + "px"
                    }));
                    var t = document.body.style.paddingRight,
                        i = window.getComputedStyle(document.body)["padding-right"];
                    q.setDataAttribute(document.body, "padding-right", t), document.body.style.paddingRight = Number.parseFloat(i) + this._scrollbarWidth + "px"
                }
                document.body.classList.add("modal-open")
            }, r._resetScrollbar = function() {
                Y.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach((function(e) {
                    var t = q.getDataAttribute(e, "padding-right");
                    void 0 !== t && (q.removeDataAttribute(e, "padding-right"), e.style.paddingRight = t)
                })), Y.find(".sticky-top").forEach((function(e) {
                    var t = q.getDataAttribute(e, "margin-right");
                    void 0 !== t && (q.removeDataAttribute(e, "margin-right"), e.style.marginRight = t)
                }));
                var e = q.getDataAttribute(document.body, "padding-right");
                void 0 === e ? document.body.style.paddingRight = "" : (q.removeDataAttribute(document.body, "padding-right"), document.body.style.paddingRight = e)
                ...
                return this.each((function() {
                    var n = x(this, "bs.modal"),
                        r = i({}, bt, q.getDataAttributes(this), "object" == typeof e && e ? e : {});
    ...
    $.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', (function(e) {
        ...
        if (e) {
            var t = e.fn.modal;
            e.fn.modal = Et.jQueryInterface, e.fn.modal.Constructor = Et, e.fn.modal.noConflict = function() {
                return e.fn.modal = t, Et.jQueryInterface
            }
        }
    }));
        ...
        for (var s = (new window.DOMParser).parseFromString(e, "text/html"), r = Object.keys(t), o = (n = []).concat.apply(n, s.body.querySelectorAll("*")), a = function(e, i) {
                ...
                l.forEach((function(e) {
                    (function(e, t) {
                        ...
                        if (t.includes(i)) return !_t.has(i) || Boolean(e.nodeValue.match(xt) || e.nodeValue.match(St));
        ...
        kt = function(e) {
            ...
            return r.enable = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    _(s, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || c.appendChild(s), $.trigger(this._element, this.constructor.Event.INSERTED), this._popper = ot(this._element, s, this._getPopperConfig(l)), s.classList.add("show");
                    var u, p, h = "function" == typeof this.config.customClass ? this.config.customClass() : this.config.customClass;
                    h && (u = s.classList).add.apply(u, h.split(" ")), "ontouchstart" in document.documentElement && (p = []).concat.apply(p, document.body.children).forEach((function(e) {
                    ...
                    if (this.tip.classList.contains("fade")) {
                        var g = d(this.tip);
                        $.one(this.tip, "transitionend", m), f(this.tip, g)
                    } else m()
                }
            }, r.hide = function() {
                var e = this;
                ...
                if (null !== e) return "object" == typeof t && p(t) ? (t.jquery && (t = t[0]), void(this.config.html ? t.parentNode !== e && (e.innerHTML = "", e.appendChild(t)) : e.textContent = t.textContent)) : void(this.config.html ? (this.config.sanitize && (t = Tt(t, this.config.allowList, this.config.sanitizeFn)), e.innerHTML = t) : e.textContent = t)
            }, r.getTitle = function() {
                ...
                var i = this.constructor.DATA_KEY;
                (t = t || x(e.delegateTarget, i)) || (t = new this.constructor(e.delegateTarget, this._getDelegateConfig()), _(e.delegateTarget, i, t)), e && (t._activeTrigger["focusout" === e.type ? "focus" : "hover"] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = "out", t.config.delay && t.config.delay.hide ? t._timeout = setTimeout((function() {
                ...
                return Object.keys(t).forEach((function(e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), h(Ct, e, this.constructor.DefaultType), e.sanitize && (e.template = Tt(e.template, e.allowList, e.sanitizeFn)), e
                ...
                var e = this.getTipElement(),
                    t = e.getAttribute("class").match(Mt);
                ...
                return this.each((function() {
                    var t = x(this, "bs.tooltip"),
                        i = "object" == typeof e && e;
                    if ((t || !/dispose|hide/.test(e)) && (t || (t = new s(this, i)), "string" == typeof e)) {
    ...
    b((function() {
        ...
        if (e) {
            var t = e.fn[Ct];
            e.fn[Ct] = kt.jQueryInterface, e.fn[Ct].Constructor = kt, e.fn[Ct].noConflict = function() {
                return e.fn[Ct] = t, kt.jQueryInterface
            }
        }
    }));
    var zt = "popover",
    ...
    b((function() {
        ...
        if (e) {
            var t = e.fn[zt];
            e.fn[zt] = Ht.jQueryInterface, e.fn[zt].Constructor = Ht, e.fn[zt].noConflict = function() {
                return e.fn[zt] = t, Ht.jQueryInterface
            }
        }
    }));
    var Bt = "scrollspy",
        ...
        Ft = function(e) {
            ...
            return r.refresh = function() {
                ...
                if ("string" != typeof(e = i({}, Wt, "object" == typeof e && e ? e : {})).target && p(e.target)) {
                    var t = e.target.id;
                    t || (t = o(Bt), e.target.id = t), e.target = "#" + t
                }
                return h(Bt, e, Rt), e
                ...
                return this.each((function() {
                    var t = x(this, "bs.scrollspy");
                    if (t || (t = new s(this, "object" == typeof e && e)), "string" == typeof e) {
                        if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                        t[e]()
                    }
                }))
    ...
    $.on(window, "load.bs.scrollspy.data-api", (function() {
        Y.find('[data-bs-spy="scroll"]').forEach((function(e) {
            return new Ft(e, q.getDataAttributes(e))
        }))
    })), b((function() {
        var e = y();
        if (e) {
            var t = e.fn[Bt];
            e.fn[Bt] = Ft.jQueryInterface, e.fn[Bt].Constructor = Ft, e.fn[Bt].noConflict = function() {
                return e.fn[Bt] = t, Ft.jQueryInterface
            }
        }
    }));
    var qt = function(e) {
        ...
        return s.show = function() {
            ...
            if (s && r) {
                var a = d(s);
                s.classList.remove("show"), $.one(s, "transitionend", o), f(s, a)
            } else o()
            ...
            return this.each((function() {
                var t = x(this, "bs.tab") || new i(this);
                if ("string" == typeof e) {
                    if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                    t[e]()
                }
    ...
    $.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', (function(e) {
        e.preventDefault(), (x(this, "bs.tab") || new qt(this)).show()
    })), b((function() {
        var e = y();
        if (e) {
            var t = e.fn.tab;
            e.fn.tab = qt.jQueryInterface, e.fn.tab.Constructor = qt, e.fn.tab.noConflict = function() {
            ...
            return r.show = function() {
                ...
                if (!$.trigger(this._element, "show.bs.toast").defaultPrevented) {
                    ...
                    if (this._element.classList.remove("hide"), v(this._element), this._element.classList.add("showing"), this._config.animation) {
                        ...
                        $.one(this._element, "transitionend", t), f(this._element, i)
                    } else t()
                }
            }, r.hide = function() {
                var e = this;
                ...
                return e = i({}, Gt, q.getDataAttributes(this._element), "object" == typeof e && e ? e : {}), h("toast", e, this.constructor.DefaultType), e
            }, r._setListeners = function() {
                var e = this;
    ...
    function i(i, r, a) {
        (a = a || t || e.jQuery) && (r.prototype.option || (r.prototype.option = function(e) {
            ...
            if ("string" != typeof e) return u = e, this.each((function(e, t) {
                var n = a.data(t, i);
                n ? (n.option(u), n._init()) : (n = new r(t, u), a.data(t, i, n))
            })), this;
            var t, n, l, c, d, u, p = s.call(arguments, 1);
    ...
    return function n(a) {
        if (function() {
                if (!o) {
                    ...
                    r.appendChild(s);
                    var a = t(s);
                    i = 200 == Math.round(e(a.width)), n.isBoxSizeOuter = i, r.removeChild(s)
                }
            ...
            var x = e(l.height);
            return !1 !== x && (c.height = x + (E ? 0 : g + w)), c.innerWidth = c.width - (m + b), c.innerHeight = c.height - (g + w), c.outerWidth = c.width + v, c.outerHeight = c.height + y, c
        }
    }
})),
function(e, t) {
    ...
    return i.htmlInit = function(t, n) {
        i.docReady((function() {
            ...
            c.forEach((function(e) {
                var i, r = e.getAttribute(o) || e.getAttribute(d);
                try {
                    i = r && JSON.parse(r)
                } catch (i) {
...
function(e, t) {
    ...
    l.constructor = i, l._create = function() {
        ...
        var e = getComputedStyle(this.element),
            ...
            r = parseFloat(n),
            o = parseFloat(s),
            a = this.layout.size; - 1 != n.indexOf("%") && (r = r / 100 * a.width), -1 != s.indexOf("%") && (o = o / 100 * a.height), r = isNaN(r) ? 0 : r, o = isNaN(o) ? 0 : o, r -= t ? a.paddingLeft : a.paddingRight, o -= i ? a.paddingTop : a.paddingBottom, this.position.x = r, this.position.y = o
...
function(e, t) {
    ...
    n.extend(p, t.prototype), p.option = function(e) {
        ...
        var i = o(r);
        return i.defaults = n.extend({}, r.defaults), n.extend(i.defaults, t), i.compatOptions = n.extend({}, r.compatOptions), i.namespace = e, i.data = r.data, i.Item = o(s), n.htmlInit(i, e), l && l.bridget && l.bridget(e, i), i
    };
    var f = {
        ms: 1,
        s: 1e3
...
function(e, t) {
    ...
    return ["_resetLayout", "_getItemLayoutPosition", "_manageStamp", "_getContainerSize", "_getElementOffset", "needsResizeLayout", "_getOption"].forEach((function(e) {
        ...
        return (s.prototype = Object.create(n)).constructor = s, t && (s.options = t), i.modes[s.prototype.namespace = e] = s
    }, i
})),
function(e, t) {
    ...
    return n._resetLayout = function() {
        ...
        for (var n = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](i, e), s = {
                ...
                y: n.y
            }, r = n.y + e.size.outerHeight, o = i + n.col, a = n.col; a < o; a++) this.colYs[a] = r;
        return s
            ...
            var t = (i = this.sortHistory, n = this.options.sortAscending, function(e, t) {
                for (var s = 0; s < i.length; s++) {
                    var r = i[s],
                        o = e.sortData[r],
                        a = t.sortData[r];
                    if (a < o || o < a) return (a < o ? 1 : -1) * ((void 0 !== n[r] ? n[r] : n) ? 1 : -1)
                }
                return 0
            });
        ...
        return this.each((function() {
            ...
            t.waypoint((function(r) {
                ! function() {
                    ...
                    for (var f = o; f >= s.beginAt / a * o; f--) {
                        var h = parseFloat(a / o * f).toFixed(c);
                        if (d) {
                            h = parseInt(i / o * f);
                    ...
                    t.data("counterup-func", (function() {
                        t.data("counterup-nums") ? (t.html(t.data("counterup-nums").shift()), t.data("counterup-nums").length ? setTimeout(t.data("counterup-func"), s.delay) : (t.data("counterup-nums", null), t.data("counterup-func", null), n.callback.call(this))) : n.callback.call(this)
...
function(e) {
    ...
    v.prototype = {
        ...
        open: function(i) {
            ...
            if (!t.isOpen) {
                t.types = [], r = "", i.mainEl && i.mainEl.length ? t.ev = i.mainEl.eq(0) : t.ev = n, i.key ? (t.popupsCache[i.key] || (t.popupsCache[i.key] = {}), t.currTemplate = t.popupsCache[i.key]) : t.currTemplate = {}, t.st = e.extend(!0, {}, e.magnificPopup.defaults, i), t.fixedContentPos = "auto" === t.st.fixedContentPos ? !t.probablyMobile : t.st.fixedContentPos, t.st.modal && (t.st.closeOnContentClick = !1, t.st.closeOnBgClick = !1, t.st.showCloseBtn = !1, t.st.enableEscapeKey = !1), t.bgOverlay || (t.bgOverlay = E("bg").on("click" + f, (function() {
                    t.close()
                })), t.wrap = E("wrap").attr("tabindex", -1).on("click" + f, (function(e) {
                    t._checkIfClose(e.target) && t.close()
                })), t.container = E("container", t.wrap)), t.contentContainer = E("content"), t.st.preloader && (t.preloader = E("preloader", t.container, t.st.tLoading));
                ...
                }), 16), t.isOpen = !0, t.updateSize(p), _(d), i
            }
            t.updateItemHTML()
        },
        close: function() {
        ...
        updateItemHTML: function() {
            ...
            if (_("BeforeChange", [t.currItem ? t.currItem.type : "", n]), t.currItem = i, !t.currTemplate[n]) {
                ...
                _("FirstMarkupParse", r), t.currTemplate[n] = !r || e(r)
            }
            s && s !== i.type && t.container.removeClass("mfp-" + s + "-holder");
            var o = t["get" + n.charAt(0).toUpperCase() + n.slice(1)](i, t.currTemplate[n]);
            t.appendContent(o, n), i.preloaded = !0, _(u, i), s = i.type, t.container.prepend(t.contentContainer), _("AfterChange")
        },
        appendContent: function(e, i) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[i] ? t.content.find(".mfp-close").length || t.content.append(x()) : t.content = e : t.content = "", _("BeforeAppend"), t.container.addClass("mfp-" + i + "-holder"), t.contentContainer.append(t.content)
        },
        parseEl: function(i) {
            var n, s = t.items[i];
            if (s.tagName ? s = {
            ...
            return s.type = n || t.st.type || "inline", s.index = i, s.parsed = !0, t.items[i] = s, _("ElementParse", s), t.items[i]
        },
        ...
        updateStatus: function(e, n) {
            if (t.preloader) {
                ...
                _("UpdateStatus", s), e = s.status, n = s.text, t.preloader.html(n), t.preloader.find("a").on("click", (function(e) {
        ...
        if ("string" == typeof i)
            if ("open" === i) {
                var s, r = y ? n.data("magnificPopup") : n[0].magnificPopup,
    ...
    var T, C, M, L = "inline",
        I = function() {
            M && (C.after(M.addClass(T)).detach(), M = null)
        };
            ...
            getInline: function(i, n) {
                if (I(), i.src) {
                    ...
                    if (r.length) {
                        ...
                        o && o.tagName && (C || (T = s.hiddenClass, C = E(T), T = "mfp-" + T), M = r.after(C).detach().removeClass(T)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(P, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(P), A = t.st.ajax.cursor, w(a + "." + P, k), w("BeforeChange." + P, k)
            },
            getAjax: function(i) {
                ...
                var n = e.extend({
                    ...
                    success: function(n, s, r) {
                        ...
                        _("ParseAjax", o), t.appendContent(e(o.data), P), i.finished = !0, O(), t._setFocus(), setTimeout((function() {
                            t.wrap.addClass(h)
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(e) {
                e.img && (e.hasSize = !0, z && clearInterval(z), e.isCheckingImgSize = !1, _("ImageHasSize", e), e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1))
            },
                ...
                var i = 0,
                    ...
                    s = function(r) {
                        z && clearInterval(z), z = setInterval((function() {
                            return n.naturalWidth > 0 ? void t._onImageHasSize(e) : (i > 200 && clearInterval(z), void(3 === ++i ? s(10) : 40 === i ? s(50) : 100 === i && s(500)))
                        }), r)
                    };
                s(1)
            },
            getImage: function(i, n) {
                var s = 0,
                    r = function() {
                        i && (i.img[0].complete ? (i.img.off(".mfploader"), i === t.currItem && (t._onImageHasSize(i), t.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, _("ImageLoadComplete")) : 200 > ++s ? setTimeout(r, 100) : o())
                    },
                    o = function() {
    ...
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(i) {
                ...
                return void 0 === j && (j = void 0 !== document.createElement("p").style.MozTransform), j ? a["-moz-transform"] = a.transform = "translate(" + s.left + "px," + s.top + "px)" : (a.left = s.left, a.top = s.top), a
            }
        }
    });
    var $ = "iframe",
    ...
    e.magnificPopup.registerModule($, {
        ...
        proto: {
            initIframe: function() {
                t.types.push($), w("BeforeChange", (function(e, t, i) {
                    t !== i && (t === $ ? N() : i === $ && N(!0))
                })), w(a + "." + $, (function() {
                    N()
                }))
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var i = t.st.gallery,
                    s = ".mfp-gallery";
                return t.direction = !0, !(!i || !i.enabled) && (r += " mfp-gallery", w(d + s, (function() {
                ...
                })), w(c + s, (function(e, n, s, r) {
                    var o = t.items.length;
                    s.counter = o > 1 ? B(i.tCounter, r.index, o) : ""
...
var $jscomp$lookupPolyfilledValue = function(e, t) {
    var i = $jscomp.propertyToPolyfillSymbol[t];
    return null == i ? e[t] : void 0 !== (i = e[i]) ? i : e[t]
};
...
var scrollCue = function() {
        ...
        return n = {
            setEvents: function(e) {
                ...
                if (o && !e && window.addEventListener("load", n.runQuery), window.addEventListener("scroll", t), a) {
            ...
            setOptions: function(e, t) {
                var i = {};
                if (void 0 !== e) return Object.keys(e).forEach((function(s) {
                    "[object Object]" === Object.prototype.toString.call(e[s]) ? i[s] = n.setOptions(e[s], t[s]) : (i[s] = e[s], void 0 !== t && void 0 !== t[s] && (i[s] = t[s]))
                })), i
            },
            searchElements: function() {
                e = [];
                for (var t = document.querySelectorAll("[data-cues]:not([data-disabled])"), s = 0; s < t.length; s++) {
                    for (var r = t[s], o = 0; o < r.children.length; o++) {
                        var l = r.children[o];
                ...
                for (t = document.querySelectorAll('[data-cue]:not([data-show="true"])'), s = 0; s < t.length; s++) r = t[s], e.push({
                    elm: r,
                ...
                if (a)
                    for (t = docSlider.getElements().pages.length, s = 0; s < t; s++)
            ...
            sortElements: function() {
                for (var e = arguments[0], t = [].slice.call(arguments).slice(1), i = {
                        $jscomp$loop$prop$i$4: 0
                    }; i.$jscomp$loop$prop$i$4 < t.length;
                    (i = {
                        $jscomp$loop$prop$i$4: i.$jscomp$loop$prop$i$4
                    }).$jscomp$loop$prop$i$4++) e.sort(function(e) {
                    return function(i, n) {
                        var s = void 0 === t[e.$jscomp$loop$prop$i$4][1] || t[e.$jscomp$loop$prop$i$4][1],
                            r = t[e.$jscomp$loop$prop$i$4][0];
            ...
            setDurationValue: function(e, t, i) {
                return void 0 === t ? e : (t = t.duration, 0 > (e = -1 === (i + "").indexOf(".") ? e + t + i : e + t + t * i) ? 0 : e)
            },
            ...
            setQuery: function() {
                ...
                for (var i = 0; i < e.length; i++) {
                    ...
                    if (!s.elm.hasAttribute("data-show")) {
                        ...
                        void 0 === t[r] && (t[r] = []), t[r].push(s)
                    }
                }
            },
            runQuery: function() {
                for (var e = Object.keys(t), i = {}, s = 0; s < e.length; i = {
                        $jscomp$loop$prop$elms$6: i.$jscomp$loop$prop$elms$6,
                        $jscomp$loop$prop$interval$7: i.$jscomp$loop$prop$interval$7
                    }, s++)
                    if (i.$jscomp$loop$prop$elms$6 = t[e[s]], n.isElementIn(i.$jscomp$loop$prop$elms$6[0].elm)) {
            ...
            isElementIn: function(e) {
                var t = e.hasAttribute("data-scpage") ? n.isScrollEndWithDocSlider : n.isScrollEnd;
                return window.pageYOffset > n.getOffsetTop(e) - window.innerHeight * i.percentage || t()
            },
            ...
            init: function(e) {
                i = n.setOptions(c, e), o = i.enable, a = i.docSlider, l = i.pageChangeReset, a || (n.setEvents(), n.searchElements(), n.setQuery())
            },
            update: function() {
                o && (n.searchElements(), n.setQuery(), n.runQuery())
            },
            enable: function(e) {
                o = void 0 === e ? !o : e, scrollCue.update()
            },
            ...
            _initWithDocSlider: function(e) {
                n.setEvents(e), n.searchElements(), n.setQuery()
            },
    ...
    Swiper = function() {
            ...
            for (let n = 1; n < arguments.length; n += 1) {
                ...
                if (null != s && (i = s, !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                    ...
                    for (let t = 0, n = i.length; t < n; t += 1) {
                        ...
                        void 0 !== r && r.enumerable && (d(e[n]) && d(s[n]) ? s[n].__swiper__ ? e[n] = s[n] : u(e[n], s[n]) : !d(e[n]) && d(s[n]) ? (e[n] = {}, s[n].__swiper__ ? e[n] = s[n] : u(e[n], s[n])) : e[n] = s[n])
                    }
                }
            }
            var i;
        ...
        function A(e) {
            return void 0 === e && (e = {}), M || (M = function(e) {
                ...
                const p = o.match(/(iPod)(.*OS\s([\d_]+))?/),
                    ...
                    h = "Win32" === s;
                let m = "MacIntel" === s;
                return !u && m && i.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${c}`) >= 0 && (u = o.match(/(Version)\/([\d.]+)/), u || (u = [0, 1, "13_0_0"]), m = !1), d && !h && (a.os = "android", a.android = !0), (u || f || p) && (a.os = "ios", a.ios = !0), a
            }(e)), M
        }
        ...
        function P() {
            return L || (L = function() {
                ...
                function n() {
                    ...
                    return t.indexOf("safasi") >= 0 && t.indexOf("chrome") < 0 && t.indexOf("android") < 0
                }
                if (n()) {
                ...
                const s = /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safasi)/i.test(e.navigator.userAgent),
                    o = n();
                return {
                    isSafasi: i || o,
            ...
            j = e => {
                ...
                if (e.params.rewind || e.params.loop)
                    for (let n = s - t; n <= r + t; n += 1) {
                        ...
                        for (let n = Math.max(s - t, 0); n <= Math.min(r + t, i - 1); n += 1) n !== s && (n > r || n < s) && D(e, n)
            };
        ...
        function H(e) {
            ...
            if ("touchstart" === s.type) return void N(t, s, s.targetTouches[0].pageX);
            const {
                params: a,
                touches: c,
                enabled: d
            ...
            Object.assign(o, {
                ...
                isScrolling: void 0,
                startMoving: void 0
            }), c.startX = g, c.startY = v, o.touchStartTime = l(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, a.threshold > 0 && (o.allowThresholdMove = !1);
            let y = !0;
            u.matches(o.focusableElements) && (y = !1, "SELECT" === u.nodeName && (o.isTouched = !1)), i.activeElement && i.activeElement.matches(o.focusableElements) && i.activeElement !== u && ("mouse" === s.pointerType || "mouse" !== s.pointerType && !u.matches(o.focusableElements)) && i.activeElement.blur();
            const b = y && t.allowTouchMove && a.touchStartPreventDefault;
            !a.touchStartForcePreventDefault && !b || u.isContentEditable || s.preventDefault(), a.freeMode && a.freeMode.enabled && t.freeMode && t.animating && !a.cssMode && t.freeMode.onTouchStart(), t.emit("touchStart", s)
        }
        ...
        function B(e) {
            ...
            if ("touchmove" === u.type) {
                if (d = [...u.changedTouches].find(e => e.identifier === s.touchId), !d || d.identifier !== s.touchId) return
            } else d = u;
            ...
            if (!i.allowTouchMove) return u.target.matches(s.focusableElements) || (i.allowClick = !1), void(s.isTouched && (Object.assign(o, {
                startX: p,
                startY: f,
                currentX: p,
                currentY: f
            ...
            if (t.activeElement && t.activeElement.matches(s.focusableElements) && t.activeElement !== u.target && "mouse" !== u.pointerType && t.activeElement.blur(), t.activeElement && u.target === t.activeElement && u.target.matches(s.focusableElements)) return s.isMoved = !0, void(i.allowClick = !1);
            s.allowTouchCallbacks && i.emit("touchMove", u), o.previousX = o.currentX, o.previousY = o.currentY, o.currentX = p, o.currentY = f;
            const h = o.currentX - o.startX,
                m = o.currentY - o.startY;
            if (i.params.threshold && Math.sqrt(h ** 2 + m ** 2) < i.params.threshold) return;
            if (void 0 === s.isScrolling) {
                let e;
                i.isHorizontal() && o.currentY === o.startY || i.isVertical() && o.currentX === o.startX ? s.isScrolling = !1 : h * h + m * m >= 25 && (e = 180 * Math.atan2(Math.abs(m), Math.abs(h)) / Math.PI, s.isScrolling = i.isHorizontal() ? e > r.touchAngle : 90 - e > r.touchAngle)
            }
            if (s.isScrolling && i.emit("touchMoveOpposite", u), void 0 === s.startMoving && (o.currentX === o.startX && o.currentY === o.startY || (s.startMoving = !0)), s.isScrolling || "touchmove" === u.type && s.preventTouchMoveFromPointerMove) return void(s.isTouched = !1);
            ...
            r.oneWayMovement && (g = Math.abs(g) * (a ? 1 : -1), v = Math.abs(v) * (a ? 1 : -1)), o.diff = g, g *= r.touchRatio, a && (g = -g, v = -v);
            ...
            if (!s.isMoved) {
                ...
                s.allowMomentumBounce = !1, !r.grabCursor || !0 !== i.allowSlideNext && !0 !== i.allowSlidePrev || i.setGrabCursor(!0), i.emit("sliderFirstMove", u)
            }
            if ((new Date).getTime(), !1 !== r._loopSwapReset && s.isMoved && s.allowThresholdMove && y !== i.touchesDirection && b && w && Math.abs(g) >= 1) return Object.assign(o, {
                startX: p,
                startY: f,
                currentX: p,
                currentY: f,
            ...
            let E = !0,
                _ = r.resistanceRatio;
            if (r.touchReleaseOnEdges && (_ = 0), g > 0 ? (b && w && s.allowThresholdMove && s.currentTranslate > (r.centeredSlides ? i.minTranslate() - i.slidesSizesGrid[i.activeIndex + 1] - ("auto" !== r.slidesPerView && i.slides.length - r.slidesPerView >= 2 ? i.slidesSizesGrid[i.activeIndex + 1] + i.params.spaceBetween : 0) - i.params.spaceBetween : i.minTranslate()) && i.loopFix({
                    direction: "prev",
                    setTranslate: !0,
                    activeSlideIndex: 0
                }), s.currentTranslate > i.minTranslate() && (E = !1, r.resistance && (s.currentTranslate = i.minTranslate() - 1 + (-i.minTranslate() + s.startTranslate + g) ** _))) : g < 0 && (b && w && s.allowThresholdMove && s.currentTranslate < (r.centeredSlides ? i.maxTranslate() + i.slidesSizesGrid[i.slidesSizesGrid.length - 1] + i.params.spaceBetween + ("auto" !== r.slidesPerView && i.slides.length - r.slidesPerView >= 2 ? i.slidesSizesGrid[i.slidesSizesGrid.length - 1] + i.params.spaceBetween : 0) : i.maxTranslate()) && i.loopFix({
                    direction: "next",
                    setTranslate: !0,
                    activeSlideIndex: i.slides.length - ("auto" === r.slidesPerView ? i.slidesPerViewDynamic() : Math.ceil(parseFloat(r.slidesPerView, 10)))
                }), s.currentTranslate < i.maxTranslate() && (E = !1, r.resistance && (s.currentTranslate = i.maxTranslate() + 1 - (i.maxTranslate() - s.startTranslate - g) ** _))), E && (u.preventedByNestedSwiper = !0), !i.allowSlideNext && "next" === i.swipeDirection && s.currentTranslate < s.startTranslate && (s.currentTranslate = s.startTranslate), !i.allowSlidePrev && "prev" === i.swipeDirection && s.currentTranslate > s.startTranslate && (s.currentTranslate = s.startTranslate), i.allowSlidePrev || i.allowSlideNext || (s.currentTranslate = s.startTranslate), r.threshold > 0) {
        ...
        function W(e) {
            ...
            if (s.originalEvent && (s = s.originalEvent), "touchend" === s.type || "touchcancel" === s.type) {
                if (n = [...s.changedTouches].find(e => e.identifier === i.touchId), !n || n.identifier !== i.touchId) return
            } else {
                if (null !== i.touchId) return;
                if (s.pointerId !== i.pointerId) return;
                n = s
            }
            if (["pointercancel", "pointerout", "pointerleave", "contextmenu"].includes(s.type) && (!["pointercancel", "contextmenu"].includes(s.type) || !t.browser.isSafasi && !t.browser.isWebView)) return;
            ...
            if (i.allowTouchCallbacks && t.emit("touchEnd", s), i.allowTouchCallbacks = !1, !i.isTouched) return i.isMoved && r.grabCursor && t.setGrabCursor(!1), i.isMoved = !1, void(i.startMoving = !1);
            ...
            let h;
            if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, h = r.followFinger ? c ? t.translate : -t.translate : -i.currentTranslate, r.cssMode) return;
            ...
            for (let e = 0; e < d.length; e += e < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
                ...
                void 0 !== d[e + t] ? (m || h >= d[e] && h < d[e + t]) && (g = e, v = d[e + t] - d[e]) : (m || h >= d[e]) && (g = e, v = d[d.length - 1] - d[d.length - 2])
            }
            let y = null,
                b = null;
            ...
            if (f > r.longSwipesMs) {
                ...
                "next" === t.swipeDirection && (w >= r.longSwipesRatio ? t.slideTo(r.rewind && t.isEnd ? y : g + E) : t.slideTo(g)), "prev" === t.swipeDirection && (w > 1 - r.longSwipesRatio ? t.slideTo(g + E) : null !== b && w < 0 && Math.abs(w) > r.longSwipesRatio ? t.slideTo(b) : t.slideTo(g))
            } else {
                if (!r.shortSwipes) return void t.slideTo(t.activeIndex);
                !t.navigation || s.target !== t.navigation.nextEl && s.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== y ? y : g + E), "prev" === t.swipeDirection && t.slideTo(null !== b ? b : g)) : s.target === t.navigation.nextEl ? t.slideTo(g + E) : t.slideTo(g)
            }
        }
        ...
        const X = (e, t) => {
                const i = n(),
                    ...
                    d = t;
                r && "string" != typeof r && (i[c]("touchstart", e.onDocumentTouchStart, {
                    passive: !1,
                    capture: l
                    ...
                    passive: !0
                }), (s.preventClicks || s.preventClicksPropagation) && r[c]("click", e.onClick, !0), s.cssMode && o[c]("scroll", e.onScroll), s.updateOnWindowResize ? e[d](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", R, !0) : e[d]("observerUpdate", R, !0), r[c]("load", e.onLoad, {
                    capture: !0
                }))
            },
        ...
        function Q(e, t) {
            return function(i) {
                ...
                "object" == typeof s && null !== s ? (!0 === e[n] && (e[n] = {
                    enabled: !0
                }), "navigation" === n && e[n] && e[n].enabled && !e[n].prevEl && !e[n].nextEl && (e[n].auto = !0), ["pagination", "scrollbar"].indexOf(n) >= 0 && e[n] && e[n].enabled && !e[n].el && (e[n].auto = !0), n in e && "enabled" in s ? ("object" != typeof e[n] || "enabled" in e[n] || (e[n].enabled = !0), e[n] || (e[n] = {
                    enabled: !1
                }), u(t, i)) : u(t, i)) : u(t, i)
            }
        }
        const K = {
                ...
                update: {
                    ...
                    updateSlides: function() {
                        ...
                        const i = e.params,
                            ...
                            d = m(s, `.${e.params.slideClass}, swiper-slide`),
                        ...
                        let _ = i.spaceBetween,
                            ...
                            C = 0;
                        if (void 0 === r) return;
                        "string" == typeof _ && _.indexOf("%") >= 0 ? _ = parseFloat(_.replace("%", "")) / 100 * r : "string" == typeof _ && (_ = parseFloat(_)), e.virtualSize = -_, d.forEach(e => {
                            o ? e.style.marginLeft = "" : e.style.marginRight = "", e.style.marginBottom = "", e.style.marginTop = ""
                        }), i.centeredSlides && i.cssMode && (p(n, "--swiper-centered-offset-before", ""), p(n, "--swiper-centered-offset-after", ""));
                        const M = i.grid && i.grid.rows > 1 && e.grid;
                        let L;
                        M ? e.grid.initSlides(d) : e.grid && e.grid.unsetSlides();
                        const I = "auto" === i.slidesPerView && i.breakpoints && Object.keys(i.breakpoints).filter(e => void 0 !== i.breakpoints[e].slidesPerView).length > 0;
                        for (let n = 0; n < u; n += 1) {
                            let s;
                            if (L = 0, d[n] && (s = d[n]), M && e.grid.updateSlide(n, s, d), !d[n] || "none" !== b(s, "display")) {
                                if ("auto" === i.slidesPerView) {
                                    I && (d[n].style[e.getDirectionLabel("width")] = "");
                                    const r = getComputedStyle(s),
                                        o = s.style.transform,
                                        a = s.style.webkitTransform;
                                    if (o && (s.style.transform = "none"), a && (s.style.webkitTransform = "none"), i.roundLengths) L = e.isHorizontal() ? x(s, "width", !0) : x(s, "height", !0);
                                    else {
                                        const e = t(r, "width"),
                                            i = t(r, "padding-left"),
                                            n = t(r, "padding-right"),
                                    ...
                                    o && (s.style.transform = o), a && (s.style.webkitTransform = a), i.roundLengths && (L = Math.floor(L))
                                } else L = (r - (i.slidesPerView - 1) * _) / i.slidesPerView, i.roundLengths && (L = Math.floor(L)), d[n] && (d[n].style[e.getDirectionLabel("width")] = L + "px");
                                d[n] && (d[n].swiperSlideSize = L), g.push(L), i.centeredSlides ? (S = S + L / 2 + T / 2 + _, 0 === T && 0 !== n && (S = S - r / 2 - _), 0 === n && (S = S - r / 2 - _), Math.abs(S) < .001 && (S = 0), i.roundLengths && (S = Math.floor(S)), C % i.slidesPerGroup == 0 && f.push(S), h.push(S)) : (i.roundLengths && (S = Math.floor(S)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && f.push(S), h.push(S), S = S + L + _), e.virtualSize += L + _, T = L, C += 1
                            }
                        }
                        if (e.virtualSize = Math.max(e.virtualSize, r) + y, o && a && ("slide" === i.effect || "coverflow" === i.effect) && (n.style.width = e.virtualSize + _ + "px"), i.setWrapperSize && (n.style[e.getDirectionLabel("width")] = e.virtualSize + _ + "px"), M && e.grid.updateWrapperSize(L, f), !i.centeredSlides) {
                            const t = [];
                        ...
                        if (u !== c && e.emit("slidesLengthChange"), f.length !== w && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== E && e.emit("slidesGridLengthChange"), i.watchSlidesProgress && e.updateSlidesOffset(), e.emit("slidesUpdated"), !(l || i.cssMode || "slide" !== i.effect && "fade" !== i.effect)) {
                    ...
                    updateSlidesProgress: function(e) {
                        ...
                        for (let e = 0; e < n.length; e += 1) {
                            ...
                            m && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)), O(l, m, i.slideVisibleClass), O(l, h, i.slideFullyVisibleClass), l.progress = s ? -d : d, l.originalProgress = s ? -u : u
                        }
                    },
                    updateProgress: function(e) {
                        ...
                        Object.assign(t, {
                            ...
                            isBeginning: r,
                            isEnd: o
                        }), (i.watchSlidesProgress || i.centeredSlides && i.autoHeight) && t.updateSlidesProgress(e), r && !l && t.emit("reachBeginning toEdge"), o && !c && t.emit("reachEnd toEdge"), (l && !r || c && !o) && t.emit("fromEdge"), t.emit("progress", s)
                    },
                    updateSlidesClasses: function() {
                        ...
                        else o ? (l = t.find(e => e.column === s), d = t.find(e => e.column === s + 1), c = t.find(e => e.column === s - 1)) : l = t[s];
                        l && (o || (d = function(e, t) {
                            const i = [];
                            ...
                            k(e, e === l, i.slideActiveClass), k(e, e === d, i.slideNextClass), k(e, e === c, i.slidePrevClass)
                        }), e.emitSlidesClasses()
                    },
                    updateActiveIndex: function(e) {
                        ...
                        if (l >= n.length && (l = n.length - 1), c === r && !t.params.loop) return void(l !== a && (t.snapIndex = l, t.emit("snapIndexChange")));
                        ...
                        Object.assign(t, {
                            ...
                            previousIndex: r,
                            activeIndex: c
                        }), t.initialized && j(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (o !== p && t.emit("realIndexChange"), t.emit("slideChange"))
                    },
                ...
                translate: {
                    ...
                    translateTo: function(e, t, i, n, s) {
                        ...
                        return 0 === t ? (r.setTransition(0), r.setTranslate(d), i && (r.emit("beforeTransitionStart", t, s), r.emit("transitionEnd"))) : (r.setTransition(t), r.setTranslate(d), i && (r.emit("beforeTransitionStart", t, s), r.emit("transitionStart")), r.animating || (r.animating = !0, r.onTranslateToWrapperTransitionEnd || (r.onTranslateToWrapperTransitionEnd = function(e) {
                            r && !r.destroyed && e.target === this && (r.wrapperEl.removeEventListener("transitionend", r.onTranslateToWrapperTransitionEnd), r.onTranslateToWrapperTransitionEnd = null, delete r.onTranslateToWrapperTransitionEnd, r.animating = !1, i && r.emit("transitionEnd"))
                ...
                slide: {
                    slideTo: function(e, t, i, n, s) {
                        ...
                        if (!m && !n && !s || r.destroyed || r.animating && a.preventInteractionOnTransition) return !1;
                        ...
                        let b;
                        o !== (d || 0) && i && r.emit("beforeSlideChangeStart"), r.updateProgress(y), b = o > u ? "next" : o < u ? "prev" : "reset";
                        const w = r.virtual && r.params.virtual.enabled;
                        if ((!w || !s) && (p && -y === r.translate || !p && y === r.translate)) return r.updateActiveIndex(o), a.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== a.effect && r.setTranslate(y), "reset" !== b && (r.transitionStart(i, b), r.transitionEnd(i, b)), !1;
                        if (a.cssMode) {
                            const e = r.isHorizontal(),
                                i = p ? y : -y;
                            if (0 === t) w && (r.wrapperEl.style.scrollSnapType = "none", r._immediateVirtual = !0), w && !r._cssModeVirtualInitialSet && r.params.initialSlide > 0 ? (r._cssModeVirtualInitialSet = !0, requestAnimationFrame(() => {
                        ...
                        const E = P().isSafasi;
                        return w && !s && E && r.isElement && r.virtual.update(!1, !1, o), r.setTransition(t), r.setTranslate(y), r.updateActiveIndex(o), r.updateSlidesClasses(), r.emit("beforeTransitionStart", t, n), r.transitionStart(i, b), 0 === t ? r.transitionEnd(i, b) : r.animating || (r.animating = !0, r.onSlideToWrapperTransitionEnd || (r.onSlideToWrapperTransitionEnd = function(e) {
                    ...
                    slideToLoop: function(e, t, i, n) {
                        ...
                        if (s.params.loop)
                            if (s.virtual && s.params.virtual.enabled) o += s.virtual.slidesBefore;
                                ...
                                let l = t - e < a;
                                if (i && (l = l || e < Math.ceil(a / 2)), n && i && "auto" !== s.params.slidesPerView && !r && (l = !1), l) {
                    ...
                    slidePrev: function(e, t, i) {
                        ...
                        if (void 0 === m && (s.cssMode || h)) {
                            let e;
                            r.forEach((t, i) => {
                                p >= t && (e = i)
                            }), void 0 !== e && (m = h ? r[e] : r[e > 0 ? e - 1 : e])
                        }
                        let g = 0;
                        if (void 0 !== m && (g = o.indexOf(m), g < 0 && (g = n.activeIndex - 1), "auto" === s.slidesPerView && 1 === s.slidesPerGroup && s.slidesPerGroupAuto && (g = g - n.slidesPerViewDynamic("previous", !0) + 1, g = Math.max(g, 0))), s.rewind && n.isBeginning) {
                    ...
                    slideToClickedSlide: function() {
                        ...
                        if (t.loop) {
                            ...
                            s = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - n / 2 || r > e.slides.length - e.loopedSlides + n / 2 ? (e.loopFix(), r = e.getSlideIndex(m(i, `${o}[data-swiper-slide-index="${s}"]`)[0]), a(() => {
                                e.slideTo(r)
                            })) : e.slideTo(r) : r > e.slides.length - n ? (e.loopFix(), r = e.getSlideIndex(m(i, `${o}[data-swiper-slide-index="${s}"]`)[0]), a(() => {
                                e.slideTo(r)
                            })) : e.slideTo(r)
                        } else e.slideTo(r)
                    }
                ...
                loop: {
                    ...
                    loopFix: function(e) {
                        ...
                        const w = [],
                            E = [];
                        let _ = l.activeIndex;
                        void 0 === r ? r = l.getSlideIndex(c.find(e => e.classList.contains(f.slideActiveClass))) : _ = r;
                        const x = "next" === n || !n,
                            S = "prev" === n || !n;
                        let T = 0,
                            C = 0;
                        const M = b ? Math.ceil(c.length / f.grid.rows) : c.length,
                            L = (b ? c[r].column : r) + (h && void 0 === s ? -m / 2 + .5 : 0);
                        if (L < y) {
                            T = Math.max(y - L, v);
                        ...
                        if (l.__preventObserver__ = !0, requestAnimationFrame(() => {
                            ...
                            }), l.recalcSlides(), "auto" === f.slidesPerView ? l.updateSlides() : b && (w.length > 0 && S || E.length > 0 && x) && l.slides.forEach((e, t) => {
                            ...
                            if (w.length > 0 && S) {
                                if (void 0 === t) {
                                    ...
                                    a ? l.setTranslate(l.translate - t) : (l.slideTo(_ + Math.ceil(T), 0, !1, !0), s && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - t, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - t))
                                } else if (s) {
                            ...
                            if (void 0 === t) {
                                const e = l.slidesGrid[_],
                                    t = l.slidesGrid[_ - C] - e;
                                a ? l.setTranslate(l.translate - t) : (l.slideTo(_ - C, 0, !1, !0), s && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - t, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - t))
                            } else {
                ...
                events: {
                    attachEvents: function() {
                        ...
                        e.onTouchStart = H.bind(e), e.onTouchMove = B.bind(e), e.onTouchEnd = W.bind(e), e.onDocumentTouchStart = G.bind(e), t.cssMode && (e.onScroll = q.bind(e)), e.onClick = F.bind(e), e.onLoad = Y.bind(e), X(e, "on")
                    },
                ...
                breakpoints: {
                    setBreakpoint: function() {
                        ...
                        const a = n(),
                            ...
                            c = ["window", "container"].includes(s.breakpointsBase) || !s.breakpointsBase ? e.el : a.querySelector(s.breakpointsBase),
                            d = e.getBreakpoint(o, l, c);
                        if (!d || e.currentBreakpoint === d) return;
                        const p = (d in o ? o[d] : void 0) || e.originalParams,
                            f = V(e, s),
                            h = V(e, p),
                            m = e.params.grabCursor,
                            g = p.grabCursor,
                            v = s.enabled;
                        f && !h ? (r.classList.remove(s.containerModifierClass + "grid", s.containerModifierClass + "grid-column"), e.emitContainerClasses()) : !f && h && (r.classList.add(s.containerModifierClass + "grid"), (p.grid.fill && "column" === p.grid.fill || !p.grid.fill && "column" === s.grid.fill) && r.classList.add(s.containerModifierClass + "grid-column"), e.emitContainerClasses()), m && !g ? e.unsetGrabCursor() : !m && g && e.setGrabCursor(), ["navigation", "pagination", "scrollbar"].forEach(t => {
                        ...
                        const y = p.direction && p.direction !== s.direction,
                            b = s.loop && (p.slidesPerView !== s.slidesPerView || y),
                            w = s.loop;
                        y && i && e.changeDirection(), u(e.params, p);
                        ...
                        }), v && !E ? e.disable() : !v && E && e.enable(), e.currentBreakpoint = d, e.emit("_beforeBreakpoint", p), i && (b ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !w && _ ? (e.loopCreate(t), e.updateSlides()) : w && !_ && e.loopDestroy()), e.emit("breakpoint", p)
                    },
        ...
        class J {
            constructor() {
                ...
                const a = this;
                a.__swiper__ = !0, a.support = I(), a.device = A({
                    userAgent: t.userAgent
                }), a.browser = P(), a.eventsListeners = {}, a.eventsAnyListeners = [], a.modules = [...a.__modules__], t.modules && Array.isArray(t.modules) && a.modules.push(...t.modules);
                const l = {};
                a.modules.forEach(e => {
                    e({
                        params: t,
                ...
                const c = u({}, U, l);
                return a.params = u({}, c, Z, t), a.originalParams = u({}, a.params), a.passedParams = u({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach(e => {
            ...
            slidesPerViewDynamic(e, t) {
                ...
                if (i.centeredSlides) {
                    ...
                    for (let e = a + 1; e < n.length; e += 1)(t ? s[e] + r[e] - s[a] < o : s[e] - s[a] < o) && (l += 1);
                else
            ...
            mount(e) {
                ...
                return !s && t.params.createElements && (s = v("div", t.params.wrapperClass), i.append(s), m(i, "." + t.params.slideClass).forEach(e => {
                    s.append(e)
                })), Object.assign(t, {
                    el: i,
                    wrapperEl: s,
            ...
            destroy(e, t) {
                ...
                return void 0 === i.params || i.destroyed || (i.emit("beforeDestroy"), i.initialized = !1, i.detachEvents(), n.loop && i.loopDestroy(), t && (i.removeClasses(), s && "string" != typeof s && s.removeAttribute("style"), r && r.removeAttribute("style"), o && o.length && o.forEach(e => {
        ...
        Object.keys(K).forEach(e => {
            ...
            i("init", () => {
                ...
                a && s.cancelAnimationFrame(a), o && o.unobserve && t.el && (o.unobserve(t.el), o = null), s.removeEventListener("resize", l), s.removeEventListener("orientationchange", c)
            })
        }, function(e) {
            let {
                swiper: t,
        ...
        const ue = [function(e) {
            ...
            function c(e, t) {
                ...
                let s;
                return n.renderSlide ? (s = n.renderSlide.call(i, e, t), "string" == typeof s && (l.innerHTML = s, s = l.children[0])) : s = i.isElement ? v("swiper-slide") : v("div", i.params.slideClass), s.setAttribute("data-swiper-slide-index", t), n.renderSlide || (s.innerHTML = e), n.cache && (i.virtual.cache[t] = s), s
            }
            ...
            function d(e, t, n) {
                ...
                let w, E, _;
                w = i.rtlTranslate ? "right" : i.isHorizontal() ? "left" : "top", a ? (E = Math.floor(s / 2) + r + p, _ = Math.floor(s / 2) + r + u) : (E = s + (r - 1) + p, _ = (l ? s : r) + u);
                let x = b - _,
                    S = b + E;
                l || (x = Math.max(x, 0), S = Math.min(S, g.length - 1));
                let T = (i.slidesGrid[x] || 0) - (i.slidesGrid[0] || 0);

                function C() {
                    i.updateSlides(), i.updateProgress(), i.updateSlidesClasses(), o("virtualUpdate")
                }
                if (l && b >= _ ? (x -= _, a || (T += i.slidesGrid[0])) : l && b < _ && (x = -_, a && (T += i.slidesGrid[0])), Object.assign(i.virtual, {
                        from: x,
                        to: S,
                        offset: T,
                        ...
                        slidesBefore: _,
                        slidesAfter: E
                    }), f === x && h === S && !e) return i.slidesGrid !== v && T !== y && i.slides.forEach(e => {
                    e.style[w] = T - Math.abs(i.cssOverflowAdjustment()) + "px"
                ...
                if (i.params.virtual.renderExternal) return i.params.virtual.renderExternal.call(i, {
                    ...
                    slides: function() {
                        const e = [];
                        for (let t = x; t <= S; t += 1) e.push(g[t]);
                        return e
                    }()
                }), void(i.params.virtual.renderExternalUpdate ? C() : o("virtualUpdate"));
                const M = [],
                    L = [],
                    I = e => {
                        let t = e;
                ...
                for (let t = A; t < P; t += 1)
                    if (t >= x && t <= S) {
                        const i = I(t);
                        void 0 === h || e ? L.push(i) : (t > h && L.push(i), t < f && M.push(i))
                    }
                if (L.forEach(e => {
            ...
            function c(e) {
                ...
                if (!(n.shiftKey || n.altKey || n.ctrlKey || n.metaKey || a.activeElement && a.activeElement.nodeName && ("input" === a.activeElement.nodeName.toLowerCase() || "textarea" === a.activeElement.nodeName.toLowerCase()))) {
                    ...
                    t.isHorizontal() ? ((c || d || u || p) && (n.preventDefault ? n.preventDefault() : n.returnValue = !1), ((d || p) && !i || (c || u) && i) && t.slideNext(), ((c || u) && !i || (d || p) && i) && t.slidePrev()) : ((c || d || f || h) && (n.preventDefault ? n.preventDefault() : n.returnValue = !1), (d || h) && t.slideNext(), (c || f) && t.slidePrev()), o("keyPress", s)
                }
            }
            ...
            function m(e) {
                return !(t.params.mousewheel.thresholdDelta && e.delta < t.params.mousewheel.thresholdDelta || t.params.mousewheel.thresholdTime && l() - u < t.params.mousewheel.thresholdTime || !(e.delta >= 6 && l() - u < 60) && (e.direction < 0 ? t.isEnd && !t.params.loop || t.animating || (t.slideNext(), s("scroll", e.raw)) : t.isBeginning && !t.params.loop || t.animating || (t.slidePrev(), s("scroll", e.raw)), u = (new o.Date).getTime(), 1))
            }
            ...
            function g(e) {
                ...
                if (v >= t.minTranslate() && (v = t.minTranslate()), v <= t.maxTranslate() && (v = t.maxTranslate()), n = !!t.params.loop || !(v === t.minTranslate() || v === t.maxTranslate()), n && t.params.nested && i.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
                    ...
                    if (!n) {
                        d = void 0;
                        let o = t.getTranslate() + f * r.sensitivity;
                        ...
                        if (o >= t.minTranslate() && (o = t.minTranslate()), o <= t.maxTranslate() && (o = t.maxTranslate()), t.setTransition(0), t.setTranslate(o), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), (!l && t.isBeginning || !u && t.isEnd) && t.updateSlidesClasses(), t.params.loop && t.loopFix({
                            ...
                            c || (c = a(() => {
                                !t.destroyed && t.params && (d = e, p.splice(0), t.slideToClosest(t.params.speed, !0, void 0, .5))
                            }, 500))
                        }
                        if (n || s("scroll", i), t.params.autoplay && t.params.autoplay.disableOnInteraction && t.autoplay.stop(), r.releaseOnEdges && (o === t.minTranslate() || o === t.maxTranslate())) return !0
                    }
                } else {
                    const i = {
                        time: l(),
            ...
            function v(e) {
                let i = t.el;
                "container" !== t.params.mousewheel.eventsTarget && (i = document.querySelector(t.params.mousewheel.eventsTarget)), i[e]("mouseenter", f), i[e]("mouseleave", h), i[e]("wheel", g)
            }
            ...
            i({
                ...
                e = S(e), i = S(i), t.enabled ? a() : [...e, ...i].filter(e => !!e).forEach(e => e.classList.add(t.params.navigation.lockClass))
            }), n("click", (e, i) => {
                let {
                    nextEl: n,
                    prevEl: r
                ...
                if (t.params.navigation.hideOnClick && !a) {
                    ...
                    let e;
                    n.length ? e = n[0].classList.contains(t.params.navigation.hiddenClass) : r.length && (e = r[0].classList.contains(t.params.navigation.hiddenClass)), s(!0 === e ? "navigationShow" : "navigationHide"), [...n, ...r].filter(e => !!e).forEach(e => e.classList.toggle(t.params.navigation.hiddenClass))
                }
            });
            const p = () => {
            ...
            function d(e) {
                ...
                if (t.params.loop) {
                    ...
                    const e = (s = t.realIndex, r = n, (r %= o = t.slides.length) == 1 + (s %= o) ? "next" : r === s - 1 ? "previous" : void 0);
            ...
            function u() {
                ...
                if (t.params.loop ? (r = t.previousRealIndex || 0, n = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (n = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, n = t.activeIndex || 0), "bullets" === i.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                    ...
                    let l, u, p;
                    if (i.dynamicBullets && (o = x(s[0], t.isHorizontal() ? "width" : "height", !0), d.forEach(e => {
                            e.style[t.isHorizontal() ? "width" : "height"] = o * (i.dynamicMainBullets + 4) + "px"
                        }), i.dynamicMainBullets > 1 && void 0 !== r && (a += n - (r || 0), a > i.dynamicMainBullets - 1 ? a = i.dynamicMainBullets - 1 : a < 0 && (a = 0)), l = Math.max(n - a, 0), u = l + (Math.min(s.length, i.dynamicMainBullets) - 1), p = (u + l) / 2), s.forEach(e => {
                ...
                d.forEach((e, r) => {
                    if ("fraction" === i.type && (e.querySelectorAll(te(i.currentClass)).forEach(e => {
                        ...
                        let o = 1,
                            a = 1;
                        "horizontal" === s ? o = r : a = r, e.querySelectorAll(te(i.progressbarFillClass)).forEach(e => {
            ...
            function p() {
                ...
                "fraction" === e.type && (r = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : `<span class="${e.currentClass}"></span> / <span class="${e.totalClass}"></span>`), "progressbar" === e.type && (r = e.renderProgressbar ? e.renderProgressbar.call(t, e.progressbarFillClass) : `<span class="${e.progressbarFillClass}"></span>`), t.pagination.bullets = [], n.forEach(i => {
                    "custom" !== e.type && (i.innerHTML = r || ""), "bullets" === e.type && t.pagination.bullets.push(...i.querySelectorAll(te(e.bulletClass)))
            ...
            n("changeDirection", () => {
                ...
                e && (e = S(e), e.forEach(e => e.classList[t.enabled ? "remove" : "add"](t.params.pagination.lockClass)))
            }), n("lock unlock", () => {
                u()
            }), n("click", (e, i) => {
                const n = i.target,
            ...
            const m = () => {
                ...
                e && (e = S(e), e.forEach(e => e.classList.add(t.params.pagination.paginationDisabledClass))), h()
            };
            Object.assign(t.pagination, {
                enable: () => {
                    ...
                    e && (e = S(e), e.forEach(e => e.classList.remove(t.params.pagination.paginationDisabledClass))), f(), p(), u()
                },
                disable: m,
                render: p,
                update: u,
            ...
            function g() {
                ...
                const {
                    ...
                    dragEl: n,
                    el: s
                } = e, r = t.params.scrollbar, o = t.params.loop ? t.progressLoop : t.progress;
                let a = d,
                    l = (u - d) * o;
                i ? (l = -l, l > 0 ? (a = d - l, l = 0) : -l + d > u && (a = u + l)) : l < 0 ? (a = d + l, l = 0) : l + d > u && (a = u - l), t.isHorizontal() ? (n.style.transform = `translate3d(${l}px, 0, 0)`, n.style.width = a + "px") : (n.style.transform = `translate3d(0px, ${l}px, 0)`, n.style.height = a + "px"), r.hide && (clearTimeout(h), s.style.opacity = 1, h = setTimeout(() => {
            ...
            function b() {
                ...
                i.style.width = "", i.style.height = "", u = t.isHorizontal() ? n.offsetWidth : n.offsetHeight, p = t.size / (t.virtualSize + t.params.slidesOffsetBefore - (t.params.centeredSlides ? t.snapGrid[0] : 0)), d = "auto" === t.params.scrollbar.dragSize ? u * p : parseInt(t.params.scrollbar.dragSize, 10), t.isHorizontal() ? i.style.width = d + "px" : i.style.height = d + "px", n.style.display = p >= 1 ? "none" : "", t.params.scrollbar.hide && (n.style.opacity = 0), t.params.watchOverflow && t.enabled && e.el.classList[t.isLocked ? "add" : "remove"](t.params.scrollbar.lockClass)
            }
            ...
            function E(e) {
                ...
                let r;
                r = (w(e) - y(s)[t.isHorizontal() ? "left" : "top"] - (null !== c ? c : d / 2)) / (u - d), r = Math.max(Math.min(r, 1), 0), n && (r = 1 - r);
            ...
            function _(e) {
                ...
                f = !0, c = e.target === a ? w(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null, e.preventDefault(), e.stopPropagation(), s.style.transitionDuration = "100ms", a.style.transitionDuration = "100ms", E(e), clearTimeout(m), o.style.transitionDuration = "0ms", i.hide && (o.style.opacity = 1), t.params.cssMode && (t.wrapperEl.style["scroll-snap-type"] = "none"), r("scrollbarDragStart", e)
            }
            ...
            function x(e) {
                ...
                f && (e.preventDefault && e.cancelable ? e.preventDefault() : e.returnValue = !1, E(e), n.style.transitionDuration = "0ms", s.style.transitionDuration = "0ms", o.style.transitionDuration = "0ms", r("scrollbarDragMove", e))
            }
            ...
            function T(e) {
                ...
                f && (f = !1, t.params.cssMode && (t.wrapperEl.style["scroll-snap-type"] = "", s.style.transitionDuration = ""), i.hide && (clearTimeout(m), m = a(() => {
            ...
            function C(e) {
                ...
                r[c]("pointerdown", _, o), l[c]("pointermove", x, o), l[c]("pointerup", T, a)
            }
            ...
            function M() {
                ...
                if (!n.el) return;
                let s, r;
                if ("string" == typeof n.el && t.isElement && (s = t.el.querySelector(n.el)), s || "string" != typeof n.el) s || (s = n.el);
                ...
                t.params.uniqueNavElements && "string" == typeof n.el && s.length > 1 && 1 === i.querySelectorAll(n.el).length && (s = i.querySelector(n.el)), s.length > 0 && (s = s[0]), s.classList.add(t.isHorizontal() ? n.horizontalClass : n.verticalClass), s && (r = s.querySelector(te(t.params.scrollbar.dragClass)), r || (r = v("div", t.params.scrollbar.dragClass), s.append(r))), Object.assign(e, {
                    el: s,
                    dragEl: r
                }), n.draggable && t.params.scrollbar.el && t.scrollbar.el && C("on"), s && s.classList[t.enabled ? "remove" : "add"](...o(t.params.scrollbar.lockClass))
            }

            function L() {
                const e = t.params.scrollbar,
                    i = t.scrollbar.el;
                i && i.classList.remove(...o(t.isHorizontal() ? e.horizontalClass : e.verticalClass)), t.params.scrollbar.el && t.scrollbar.el && C("off")
            }
            i({
                scrollbar: {
                    el: null,
                ...
                !1 === t.params.scrollbar.enabled ? I() : (M(), b(), g())
            ...
            Object.assign(t.scrollbar, {
                enable: () => {
                    t.el.classList.remove(...o(t.params.scrollbar.scrollbarDisabledClass)), t.scrollbar.el && t.scrollbar.el.classList.remove(...o(t.params.scrollbar.scrollbarDisabledClass)), M(), b(), g()
                },
                disable: I,
                updateSize: b,
                setTranslate: g,
            ...
            const s = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]",
                r = (e, i) => {
                    const {
                        rtl: n
                    } = t, s = n ? -1 : 1, r = e.getAttribute("data-swiper-parallax") || "0";
                    ...
                    if (o || a ? (o = o || "0", a = a || "0") : t.isHorizontal() ? (o = r, a = "0") : (a = r, o = "0"), o = o.indexOf("%") >= 0 ? parseInt(o, 10) * i * s + "%" : o * i * s + "px", a = a.indexOf("%") >= 0 ? parseInt(a, 10) * i + "%" : a * i + "px", null != c) {
                ...
                o = () => {
                    ...
                    t.isElement && l.push(...m(t.hostEl, s)), l.forEach(e => {
                        ...
                        let a = e.progress;
                        t.params.slidesPerGroup > 1 && "auto" !== t.params.slidesPerView && (a += Math.ceil(i / 2) - n * (o.length - 1)), a = Math.min(Math.max(a, -1), 1), e.querySelectorAll(s + ", [data-swiper-parallax-rotate]").forEach(e => {
                            r(e, a)
                        })
                    })
                };
            ...
            function M(e) {
                if ("mouse" === e.pointerType && h.splice(0, h.length), !T(e)) return;
                const i = t.params.zoom;
                if (p = !1, f = !1, h.push(e), !(h.length < 2)) {
                    if (p = !0, g.scaleStart = x(), !g.slideEl) {
                        ...
                        if (n && (n = n.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), g.imageEl = n, g.imageWrapEl = n ? E(g.imageEl, "." + i.containerClass)[0] : void 0, !g.imageWrapEl) return void(g.imageEl = void 0);
                        g.maxRatio = S()
                    }
                    if (g.imageEl) {
                        const [e, t] = function() {
                            ...
                            return [(h[0].pageX + (h[1].pageX - h[0].pageX) / 2 - e.x - o.scrollX) / a, (h[0].pageY + (h[1].pageY - h[0].pageY) / 2 - e.y - o.scrollY) / a]
                        }();
            ...
            function L(e) {
                ...
                const i = t.params.zoom,
                    n = t.zoom,
                    s = h.findIndex(t => t.pointerId === e.pointerId);
                s >= 0 && (h[s] = e), h.length < 2 || (f = !0, g.scaleMove = x(), g.imageEl && (n.scale = g.scaleMove / g.scaleStart * a, n.scale > g.maxRatio && (n.scale = g.maxRatio - 1 + (n.scale - g.maxRatio + 1) ** .5), n.scale < i.minRatio && (n.scale = i.minRatio + 1 - (i.minRatio - n.scale + 1) ** .5), g.imageEl.style.transform = `translate3d(0,0,0) scale(${n.scale})`))
            }
            ...
            function P(e) {
                ...
                const n = t.zoom;
                if (!g.imageEl) return;
                if (!v.isTouched || !g.slideEl) return void(i && k(e));
                ...
                const s = v.width * n.scale,
                    r = v.height * n.scale;
                if (v.minX = Math.min(g.slideWidth / 2 - s / 2, 0), v.maxX = -v.minX, v.minY = Math.min(g.slideHeight / 2 - r / 2, 0), v.maxY = -v.minY, v.touchesCurrent.x = h.length > 0 ? h[0].pageX : e.pageX, v.touchesCurrent.y = h.length > 0 ? h[0].pageY : e.pageY, Math.max(Math.abs(v.touchesCurrent.x - v.touchesStart.x), Math.abs(v.touchesCurrent.y - v.touchesStart.y)) > 5 && (t.allowClick = !1), !v.isMoved && !l) {
                    if (t.isHorizontal() && (Math.floor(v.minX) === Math.floor(v.startX) && v.touchesCurrent.x < v.touchesStart.x || Math.floor(v.maxX) === Math.floor(v.startX) && v.touchesCurrent.x > v.touchesStart.x)) return v.isTouched = !1, void A();
                    if (!t.isHorizontal() && (Math.floor(v.minY) === Math.floor(v.startY) && v.touchesCurrent.y < v.touchesStart.y || Math.floor(v.maxY) === Math.floor(v.startY) && v.touchesCurrent.y > v.touchesStart.y)) return v.isTouched = !1, void A()
                }
                ...
                v.currentX = v.touchesCurrent.x - v.touchesStart.x + v.startX + o * (v.width - 2 * d), v.currentY = v.touchesCurrent.y - v.touchesStart.y + v.startY + o * (v.height - 2 * u), v.currentX < v.minX && (v.currentX = v.minX + 1 - (v.minX - v.currentX + 1) ** .8), v.currentX > v.maxX && (v.currentX = v.maxX - 1 + (v.currentX - v.maxX + 1) ** .8), v.currentY < v.minY && (v.currentY = v.minY + 1 - (v.minY - v.currentY + 1) ** .8), v.currentY > v.maxY && (v.currentY = v.maxY - 1 + (v.currentY - v.maxY + 1) ** .8), b.prevPositionX || (b.prevPositionX = v.touchesCurrent.x), b.prevPositionY || (b.prevPositionY = v.touchesCurrent.y), b.prevTime || (b.prevTime = Date.now()), b.x = (v.touchesCurrent.x - b.prevPositionX) / (Date.now() - b.prevTime) / 2, b.y = (v.touchesCurrent.y - b.prevPositionY) / (Date.now() - b.prevTime) / 2, Math.abs(v.touchesCurrent.x - b.prevPositionX) < 2 && (b.x = 0), Math.abs(v.touchesCurrent.y - b.prevPositionY) < 2 && (b.y = 0), b.prevPositionX = v.touchesCurrent.x, b.prevPositionY = v.touchesCurrent.y, b.prevTime = Date.now(), g.imageWrapEl.style.transform = `translate3d(${v.currentX}px, ${v.currentY}px,0)`
            }
            ...
            function k(e) {
                ...
                const t = o.getComputedStyle(g.imageWrapEl).transform,
                    i = new o.DOMMatrix(t);
                if (!d) return d = !0, u.x = e.clientX, u.y = e.clientY, v.startX = i.e, v.startY = i.f, v.width = g.imageEl.offsetWidth || g.imageEl.clientWidth, v.height = g.imageEl.offsetHeight || g.imageEl.clientHeight, g.slideWidth = g.slideEl.offsetWidth, void(g.slideHeight = g.slideEl.offsetHeight);
                const n = -3 * (e.clientX - u.x),
                    ...
                    c = g.slideWidth,
                    p = g.slideHeight,
                    f = Math.min(c / 2 - r / 2, 0),
                    h = -f,
                    m = Math.min(p / 2 - l / 2, 0),
                    y = -m,
                    b = Math.max(Math.min(v.startX + n, h), f),
                    w = Math.max(Math.min(v.startY + s, y), m);
            ...
            function z(e) {
                ...
                if (!g.slideEl) {
                    ...
                    i && (i = i.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), g.imageEl = i, g.imageWrapEl = i ? E(g.imageEl, "." + n.containerClass)[0] : void 0
                }
                if (!g.imageEl || !g.imageWrapEl) return;
                let s, r, l, c, d, u, p, f, h, b, w, _, x, T, C, M, L, I;
                t.params.cssMode && (t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.touchAction = "none"), g.slideEl.classList.add("" + n.zoomedSlideClass), void 0 === v.touchesStart.x && e ? (s = e.pageX, r = e.pageY) : (s = v.touchesStart.x, r = v.touchesStart.y);
                const A = "number" == typeof e ? e : null;
                1 === a && A && (s = void 0, r = void 0, v.touchesStart.x = void 0, v.touchesStart.y = void 0);
                const P = S();
                i.scale = A || P, a = A || P, !e || 1 === a && A ? (p = 0, f = 0) : (L = g.slideEl.offsetWidth, I = g.slideEl.offsetHeight, l = y(g.slideEl).left + o.scrollX, c = y(g.slideEl).top + o.scrollY, d = l + L / 2 - s, u = c + I / 2 - r, h = g.imageEl.offsetWidth || g.imageEl.clientWidth, b = g.imageEl.offsetHeight || g.imageEl.clientHeight, w = h * i.scale, _ = b * i.scale, x = Math.min(L / 2 - w / 2, 0), T = Math.min(I / 2 - _ / 2, 0), C = -x, M = -T, p = d * i.scale, f = u * i.scale, p < x && (p = x), p > C && (p = C), f < T && (f = T), f > M && (f = M)), A && 1 === i.scale && (g.originX = 0, g.originY = 0), g.imageWrapEl.style.transitionDuration = "300ms", g.imageWrapEl.style.transform = `translate3d(${p}px, ${f}px,0)`, g.imageEl.style.transitionDuration = "300ms", g.imageEl.style.transform = `translate3d(0,0,0) scale(${i.scale})`
            }
            ...
            function D() {
                ...
                if (!g.slideEl) {
                    ...
                    e && (e = e.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), g.imageEl = e, g.imageWrapEl = e ? E(g.imageEl, "." + i.containerClass)[0] : void 0
                }
                g.imageEl && g.imageWrapEl && (t.params.cssMode && (t.wrapperEl.style.overflow = "", t.wrapperEl.style.touchAction = ""), e.scale = 1, a = 1, v.touchesStart.x = void 0, v.touchesStart.y = void 0, g.imageWrapEl.style.transitionDuration = "300ms", g.imageWrapEl.style.transform = "translate3d(0,0,0)", g.imageEl.style.transitionDuration = "300ms", g.imageEl.style.transform = "translate3d(0,0,0) scale(1)", g.slideEl.classList.remove("" + i.zoomedSlideClass), g.slideEl = void 0, g.originX = 0, g.originY = 0, t.params.zoom.panOnMouseMove && (u = {
                    x: 0,
                    y: 0
                }, d && (d = !1, v.startX = 0, v.startY = 0)))
            }

            function j(e) {
                const i = t.zoom;
                i.scale && 1 !== i.scale ? D() : z(e)
            }
            ...
            function N() {
                ...
                t.wrapperEl.addEventListener("pointerdown", M, i), t.wrapperEl.addEventListener("pointermove", L, n), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
                    t.wrapperEl.addEventListener(e, I, i)
            ...
            function H() {
                ...
                t.wrapperEl.removeEventListener("pointerdown", M, i), t.wrapperEl.removeEventListener("pointermove", L, n), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
                    t.wrapperEl.removeEventListener(e, I, i)
            ...
            Object.defineProperty(t.zoom, "scale", {
                ...
                t.zoom.enabled && function() {
                    ...
                    const s = b.x * i,
                        ...
                        o = b.y * n,
                        a = v.currentY + o;
                    0 !== b.x && (i = Math.abs((r - v.currentX) / b.x)), 0 !== b.y && (n = Math.abs((a - v.currentY) / b.y));
                    const l = Math.max(i, n);
                    v.currentX = r, v.currentY = a;
                ...
                !t.animating && t.params.zoom.enabled && t.zoom.enabled && t.params.zoom.toggle && j(i)
            }), n("transitionEnd", () => {
            ...
            i({
                ...
                "undefined" != typeof window && ("string" == typeof t.params.controller.control || t.params.controller.control instanceof HTMLElement) ? ("string" == typeof t.params.controller.control ? [...document.querySelectorAll(t.params.controller.control)] : [t.params.controller.control]).forEach(e => {
                    if (t.controller.control || (t.controller.control = []), e && e.swiper) t.controller.control.push(e.swiper);
                        ...
                        const i = t.params.eventsPrefix + "init",
                            n = s => {
                                t.controller.control.push(s.detail[0]), t.update(), e.removeEventListener(i, n)
                            };
                ...
                setTranslate: function(e, i) {
                    ...
                    function l(e) {
                        ...
                        }(e), o = -t.controller.spline.interpolate(-i)), o && "container" !== t.params.controller.by || (r = (e.maxTranslate() - e.minTranslate()) / (t.maxTranslate() - t.minTranslate()), !Number.isNaN(r) && Number.isFinite(r) || (r = 1), o = (i - t.minTranslate()) * r + e.minTranslate()), t.params.controller.inverse && (o = e.maxTranslate() - o), e.updateProgress(o), e.setTranslate(o, t), e.updateActiveIndex(), e.updateSlidesClasses()
                    }
                    if (Array.isArray(n))
            ...
            function y(e) {
                ...
                if (!t.pagination || !t.pagination.el || n !== t.pagination.el && !t.pagination.el.contains(e.target) || e.target.matches(te(t.params.pagination.bulletClass))) {
                    if (t.navigation && t.navigation.prevEl && t.navigation.nextEl) {
                        const e = S(t.navigation.prevEl);
                        S(t.navigation.nextEl).includes(n) && (t.isEnd && !t.params.loop || t.slideNext(), t.isEnd ? c(i.lastSlideMessage) : c(i.nextSlideMessage)), e.includes(n) && (t.isBeginning && !t.params.loop || t.slidePrev(), t.isBeginning ? c(i.firstSlideMessage) : c(i.prevSlideMessage))
                    }
            ...
            const _ = (e, t, i) => {
                    d(e), "BUTTON" !== e.tagName && (p(e, "button"), e.addEventListener("keydown", y)), h(e, i),
                        function(e, t) {
                            (e = S(e)).forEach(e => {
                ...
                M = e => {
                    ...
                    n || s || e.sourceCapabilities && e.sourceCapabilities.firesTouchEvents || (t.isHorizontal() ? t.el.scrollLeft = 0 : t.el.scrollTop = 0, requestAnimationFrame(() => {
                ...
                L = () => {
                    ...
                    e.slideLabelMessage && t.slides.forEach((n, s) => {
                        ...
                        h(n, e.slideLabelMessage.replace(/\{\{index\}\}/, r + 1).replace(/\{\{slidesLength\}\}/, i))
                    })
                };
            s("beforeInit", () => {
                ...
                t.params.a11y.enabled && (() => {
                    ...
                    t.el.append(a);
                    const i = t.el;
                    e.containerRoleDescriptionMessage && f(i, e.containerRoleDescriptionMessage), e.containerMessage && h(i, e.containerMessage), e.containerRole && p(i, e.containerRole);
                    const s = t.wrapperEl,
                    ...
                    d = S(d), u = S(u), d && d.forEach(t => _(t, r, e.nextSlideMessage)), u && u.forEach(t => _(t, r, e.prevSlideMessage)), E() && S(t.pagination.el).forEach(e => {
                        e.addEventListener("keydown", y)
                    }), n().addEventListener("visibilitychange", C), t.el.addEventListener("focus", M, !0), t.el.addEventListener("focus", M, !0), t.el.addEventListener("pointerdown", x, !0), t.el.addEventListener("pointerup", T, !0)
                })()
                ...
                t.params.a11y.enabled && function() {
                    ...
                    i && (t.isBeginning ? (m(i), u(i)) : (g(i), d(i))), e && (t.isEnd ? (m(e), u(e)) : (g(e), d(e)))
                }()
            }), s("paginationUpdate", () => {
                t.params.a11y.enabled && function() {
                    const e = t.params.a11y;
                    b() && t.pagination.bullets.forEach(i => {
                        t.params.pagination.clickable && (d(i), t.params.pagination.renderBullet || (p(i, "button"), h(i, e.paginationBulletMessage.replace(/\{\{index\}\}/, w(i) + 1)))), i.matches(te(t.params.pagination.bulletActiveClass)) ? i.setAttribute("aria-current", "true") : i.removeAttribute("aria-current")
                    })
                }()
            }), s("destroy", () => {
                t.params.a11y.enabled && function() {
                    ...
                    e = S(e), i = S(i), e && e.forEach(e => e.removeEventListener("keydown", y)), i && i.forEach(e => e.removeEventListener("keydown", y)), E() && S(t.pagination.el).forEach(e => {
                        e.removeEventListener("keydown", y)
                    }), n().removeEventListener("visibilitychange", C), t.el && "string" != typeof t.el && (t.el.removeEventListener("focus", M, !0), t.el.removeEventListener("pointerdown", x, !0), t.el.removeEventListener("pointerup", T, !0))
                }()
            })
        }, function(e) {
            let {
            ...
            n("init", () => {
                t.params.history.enabled && (() => {
                    ...
                    if (t.params.history) {
                        ...
                        s = !0, o = l(t.params.url), o.key || o.value ? (d(0, o.value, t.params.runCallbacksOnInit), t.params.history.replaceState || e.addEventListener("popstate", u)) : t.params.history.replaceState || e.addEventListener("popstate", u)
                    }
                })()
            }), n("destroy", () => {
                t.params.history.enabled && (() => {
            ...
            const d = () => {
                ...
                u = () => {
                    ...
                    t.params.hashNavigation.replaceState && c.history && c.history.replaceState ? (c.history.replaceState(null, null, "#" + i || ""), s("hashSet")) : (l.location.hash = i || "", s("hashSet"))
                };
            o("init", () => {
            ...
            let c, d, u, p, f, h, m, g, v = l && l.autoplay ? l.autoplay.delay : 3e3,
                y = l && l.autoplay ? l.autoplay.delay : 3e3,
                b = (new Date).getTime();

            function w(e) {
                s && !s.destroyed && s.wrapperEl && e.target === s.wrapperEl && (s.wrapperEl.removeEventListener("transitionend", w), g || e.detail && e.detail.bySwiperTouchMove || C())
            }
            const E = () => {
                    if (s.destroyed || !s.autoplay.running) return;
                    s.autoplay.paused ? d = !0 : d && (y = c, d = !1);
                    const e = s.autoplay.paused ? c : b + y - (new Date).getTime();
                    s.autoplay.timeLeft = e, a("autoplayTimeLeft", e, e / v), i = requestAnimationFrame(() => {
                        E()
                    })
                },
                _ = e => {
                    ...
                    const r = (() => {
                        let e;
                        if (e = s.virtual && s.params.virtual.enabled ? s.slides.find(e => e.classList.contains("swiper-slide-active")) : s.slides[s.activeIndex], e) return parseInt(e.getAttribute("data-swiper-autoplay"), 10)
                    })();
                ...
                T = (e, i) => {
                    ...
                    const n = () => {
                        a("autoplayPause"), s.params.autoplay.waitForTransition ? s.wrapperEl.addEventListener("transitionend", w) : C()
                    };
                    if (s.autoplay.paused = !0, i) return h && (c = s.params.autoplay.delay), h = !1, void n();
                    const r = c || s.params.autoplay.delay;
                    c = r - ((new Date).getTime() - b), s.isEnd && c < 0 && !s.params.loop || (c < 0 && (c = 0), n())
                },
                C = () => {
                    s.isEnd && c < 0 && !s.params.loop || s.destroyed || !s.autoplay.running || (b = (new Date).getTime(), m ? (m = !1, _(c)) : _(), s.autoplay.paused = !1, a("autoplayResume"))
                },
                M = () => {
                    if (s.destroyed || !s.autoplay.running) return;
                    const e = n();
                ...
                L = e => {
                    "mouse" === e.pointerType && (m = !0, g = !0, s.animating || s.autoplay.paused || T(!0))
                },
                I = e => {
                    "mouse" === e.pointerType && (g = !1, s.autoplay.paused && C())
                };
            o("init", () => {
                s.params.autoplay.enabled && (s.params.autoplay.pauseOnMouseEnter && (s.el.addEventListener("pointerenter", L), s.el.addEventListener("pointerleave", I)), n().addEventListener("visibilitychange", M), x())
            }), o("destroy", () => {
                s.el && "string" != typeof s.el && (s.el.removeEventListener("pointerenter", L), s.el.removeEventListener("pointerleave", I)), n().removeEventListener("visibilitychange", M), s.autoplay.running && S()
            }), o("_freeModeStaticRelease", () => {
                (p || m) && C()
            }), o("_freeModeNoMomentumRelease", () => {
                s.params.autoplay.disableOnInteraction ? S() : T(!0, !0)
            }), o("beforeTransitionStart", (e, t, i) => {
                !s.destroyed && s.autoplay.running && (i || !s.params.autoplay.disableOnInteraction ? T(!0, !0) : S())
            }), o("sliderFirstMove", () => {
                !s.destroyed && s.autoplay.running && (s.params.autoplay.disableOnInteraction ? S() : (u = !0, p = !1, m = !1, f = setTimeout(() => {
                    m = !0, p = !0, T(!0)
                }, 200)))
            }), o("touchEnd", () => {
                if (!s.destroyed && s.autoplay.running && u) {
                    if (clearTimeout(f), clearTimeout(t), s.params.autoplay.disableOnInteraction) return p = !1, void(u = !1);
            ...
            function a() {
                ...
                if (null == i) return;
                let s;
                s = e.params.loop ? parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10) : i, t.params.loop ? t.slideToLoop(s) : t.slideTo(s)
            }
            ...
            function c(e) {
                ...
                if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (s = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (s = 1), s = Math.floor(s), i.slides.forEach(e => e.classList.remove(r)), i.params.loop || i.params.virtual && i.params.virtual.enabled)
                    for (let e = 0; e < s; e += 1) m(i.slidesEl, `[data-swiper-slide-index="${t.realIndex+e}"]`).forEach(e => {
                        e.classList.add(r)
                    });
                else
                    for (let e = 0; e < s; e += 1) i.slides[t.realIndex + e] && i.slides[t.realIndex + e].classList.add(r);
                ...
                if (t.realIndex !== i.realIndex || a) {
                    ...
                    a && (r += "next" === l ? o : -1 * o), i.visibleSlidesIndexes && i.visibleSlidesIndexes.indexOf(r) < 0 && (i.params.centeredSlides ? r = r > s ? r - Math.floor(n / 2) + 1 : r + Math.floor(n / 2) - 1 : r > s && i.params.slidesPerGroup, i.slideTo(r, e ? 0 : void 0))
                }
            }
            t.thumbs = {
                swiper: null
                        ...
                        const i = n(),
                            s = () => {
                                ...
                                if (n && n.swiper) e.swiper = n.swiper, l(), c(!0);
                                    ...
                                    const i = t.params.eventsPrefix + "init",
                                        s = r => {
                                            e.swiper = r.detail[0], n.removeEventListener(i, s), l(), c(!0), e.swiper.update(), t.update()
                                        };
                            ...
                            if (r.freeMode.momentum) {
                                if (d.velocities.length > 1) {
                                    const e = d.velocities.pop(),
                                        ...
                                        s = e.time - i.time;
                                    t.velocity = n / s, t.velocity /= 2, Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (s > 150 || l() - e.time > 300) && (t.velocity = 0)
                                } else t.velocity = 0;
                                ...
                                let m;
                                if (u < t.maxTranslate()) r.freeMode.momentumBounce ? (u + t.maxTranslate() < -h && (u = t.maxTranslate() - h), p = t.maxTranslate(), f = !0, d.allowMomentumBounce = !0) : u = t.maxTranslate(), r.loop && r.centeredSlides && (m = !0);
                                else if (u > t.minTranslate()) r.freeMode.momentumBounce ? (u - t.minTranslate() > h && (u = t.minTranslate() + h), p = t.minTranslate(), f = !0, d.allowMomentumBounce = !0) : u = t.minTranslate(), r.loop && r.centeredSlides && (m = !0);
                                ...
                                if (m && s("transitionEnd", () => {
                                    ...
                                    if (e = a ? Math.abs((-u - t.translate) / t.velocity) : Math.abs((u - t.translate) / t.velocity), r.freeMode.sticky) {
                                        const i = Math.abs((a ? -u : u) - t.translate),
                                            n = t.slidesSizesGrid[t.activeIndex];
                                        e = i < n ? r.speed : i < 2 * n ? 1.5 * r.speed : 2.5 * r.speed
                                    }
                                } else if (r.freeMode.sticky) return void t.slideToClosest();
                                r.freeMode.momentumBounce && f ? (t.updateProgress(p), t.setTransition(e), t.setTranslate(u), t.transitionStart(!0, t.swipeDirection), t.animating = !0, _(o, () => {
                                    t && !t.destroyed && d.allowMomentumBounce && (n("momentumBounce"), t.setTransition(r.speed), setTimeout(() => {
                                        t.setTranslate(p), _(o, () => {
                                            t && !t.destroyed && t.transitionEnd()
                                        })
                                    }, 0))
                                })) : t.velocity ? (n("_freeModeNoMomentumRelease"), t.updateProgress(u), t.setTransition(e), t.setTranslate(u), t.transitionStart(!0, t.swipeDirection), t.animating || (t.animating = !0, _(o, () => {
                                    t && !t.destroyed && t.transitionEnd()
                                }))) : t.updateProgress(u), t.updateActiveIndex(), t.updateSlidesClasses()
                            } else {
                                if (r.freeMode.sticky) return void t.slideToClosest();
                                r.freeMode && n("_freeModeNoMomentumRelease")
                            }(!r.freeMode.momentum || u >= r.longSwipesMs) && (n("_freeModeStaticRelease"), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses())
                        }
                    }
                }
            })
            ...
            a("init", () => {
                ...
                s && !i ? (t.classList.remove(e.containerModifierClass + "grid", e.containerModifierClass + "grid-column"), n = 1, r.emitContainerClasses()) : !s && i && (t.classList.add(e.containerModifierClass + "grid"), "column" === e.grid.fill && t.classList.add(e.containerModifierClass + "grid-column"), r.emitContainerClasses()), s = i
            }), r.grid = {
                initSlides: e => {
                    const {
                        slidesPerView: s
                        ...
                        rows: o,
                        fill: a
                    } = r.params.grid, l = r.virtual && r.params.virtual.enabled ? r.virtual.slides.length : e.length;
                    n = Math.floor(l / o), t = Math.floor(l / o) === l / o ? l : Math.ceil(l / o) * o, "auto" !== s && "row" === a && (t = Math.max(t, s * o)), i = t / o
                },
                unsetSlides: () => {
                ...
                updateSlide: (e, s, o) => {
                    const {
                        ...
                        rows: d,
                        fill: u
                    } = r.params.grid, p = r.virtual && r.params.virtual.enabled ? r.virtual.slides.length : o.length;
                    let f, h, m;
                    if ("row" === u && a > 1) {
                        const i = Math.floor(e / (a * d)),
                            n = e - d * a * i,
                            r = 0 === i ? a : Math.min(Math.ceil((p - i * d * a) / d), a);
                        m = Math.floor(n / r), h = n - m * r + i * a, f = h + m * t / d, s.style.order = f
                    } else "column" === u ? (h = Math.floor(e / d), m = e - h * d, (h > n || h === n && m === d - 1) && (m += 1, m >= d && (m = 0, h += 1))) : (m = Math.floor(e / i), h = e - m * i);
                    s.row = m, s.column = h, s.style.height = `calc((100% - ${(d-1)*c}px) / ${d})`, s.style[r.getDirectionLabel("margin-top")] = 0 !== m ? c && c + "px" : "", s.swiperSlideGridSet = !0
                },
                updateWrapperSize: (e, i) => {
                    ...
                    if (r.virtualSize = (e + o) * t, r.virtualSize = Math.ceil(r.virtualSize / a) - o, r.params.cssMode || (r.wrapperEl.style[r.getDirectionLabel("width")] = r.virtualSize + o + "px"), n) {
                        const e = [];
            ...
            const s = (e, t, i) => {
                ...
                n || (n = v("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (i ? "left" : "top")).split(" ")), e.append(n)), s || (s = v("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (i ? "right" : "bottom")).split(" ")), e.append(s)), n && (n.style.opacity = Math.max(-t, 0)), s && (s.style.opacity = Math.max(t, 0))
            };
            ae({
                effect: "cube",
                swiper: t,
                ...
                setTranslate: () => {
                    const {
                        ...
                        size: l,
                        browser: c
                    } = t, d = T(t), u = t.params.cubeEffect, p = t.isHorizontal(), f = t.virtual && t.params.virtual.enabled;
                    let h, m = 0;
                    u.shadow && (p ? (h = t.wrapperEl.querySelector(".swiper-cube-shadow"), h || (h = v("div", "swiper-cube-shadow"), t.wrapperEl.append(h)), h.style.height = r + "px") : (h = e.querySelector(".swiper-cube-shadow"), h || (h = v("div", "swiper-cube-shadow"), e.append(h))));
                    for (let e = 0; e < n.length; e += 1) {
                        const t = n[e];
                        let i = e;
                        ...
                        let h = 0,
                            g = 0,
                            v = 0;
                        i % 4 == 0 ? (h = 4 * -o * l, v = 0) : (i - 1) % 4 == 0 ? (h = 0, v = 4 * -o * l) : (i - 2) % 4 == 0 ? (h = l + 4 * o * l, v = l) : (i - 3) % 4 == 0 && (h = -l, v = 3 * l + 4 * l * o), a && (h = -h), p || (g = h, h = 0);
                        const y = `rotateX(${d(p?0:-r)}deg) rotateY(${d(p?r:0)}deg) translate3d(${h}px, ${g}px, ${v}px)`;
                        c <= 1 && c > -1 && (m = 90 * i + 90 * c, a && (m = 90 * -i - 90 * c)), t.style.transform = y, u.slideShadows && s(t, c, p)
                    }
                    if (i.style.transformOrigin = `50% 50% -${l/2}px`, i.style["-webkit-transform-origin"] = `50% 50% -${l/2}px`, u.shadow)
                        if (p) h.style.transform = `translate3d(0px, ${r/2+u.shadowOffset}px, ${-r/2}px) rotateX(89.99deg) rotateZ(0deg) scale(${u.shadowScale})`;
                        else {
                            const e = Math.abs(m) - 90 * Math.floor(Math.abs(m) / 90),
                                ...
                                n = u.shadowScale / t,
                                s = u.shadowOffset;
                            h.style.transform = `scale3d(${i}, 1, ${n}) translate3d(0px, ${o/2+s}px, ${-o/2/n}px) rotateX(-89.99deg)`
                        }
                    const g = (c.isSafasi || c.isWebView) && c.needPerspectiveFix ? -l / 2 : 0;
                    i.style.transform = `translate3d(0px,0,${g}px) rotateX(${d(t.isHorizontal()?0:m)}deg) rotateY(${d(t.isHorizontal()?-m:0)}deg)`, i.style.setProperty("--swiper-cube-translate-z", g + "px")
                },
                setTransition: e => {
                    const {
                        el: i,
            ...
            const s = (e, i) => {
                ...
                n || (n = de("flip", e, t.isHorizontal() ? "left" : "top")), s || (s = de("flip", e, t.isHorizontal() ? "right" : "bottom")), n && (n.style.opacity = Math.max(-i, 0)), s && (s.style.opacity = Math.max(i, 0))
            };
            ae({
                effect: "flip",
                swiper: t,
                ...
                setTranslate: () => {
                    ...
                    for (let o = 0; o < e.length; o += 1) {
                        ...
                        let d = -180 * l,
                            ...
                            f = 0;
                        t.isHorizontal() ? i && (d = -d) : (f = p, p = 0, u = -d, d = 0), a.style.zIndex = -Math.abs(Math.round(l)) + e.length, n.slideShadows && s(a, l);
                        const h = `translate3d(${p}px, ${f}px, 0px) rotateX(${r(u)}deg) rotateY(${r(d)}deg)`;
                ...
                recreateShadows: () => {
                    t.params.flipEffect, t.slides.forEach(e => {
                        let i = e.progress;
                        t.params.flipEffect.limitRotation && (i = Math.max(Math.min(e.progress, 1), -1)), s(e, i)
                    })
                },
            ...
            i({
                ...
                setTranslate: () => {
                    const {
                        ...
                        slides: n,
                        slidesSizesGrid: s
                    } = t, r = t.params.coverflowEffect, o = t.isHorizontal(), a = t.translate, l = o ? e / 2 - a : i / 2 - a, c = o ? r.rotate : -r.rotate, d = r.depth, u = T(t);
                    for (let e = 0, t = n.length; e < t; e += 1) {
                        ...
                        Math.abs(y) < .001 && (y = 0), Math.abs(v) < .001 && (v = 0), Math.abs(m) < .001 && (m = 0), Math.abs(f) < .001 && (f = 0), Math.abs(h) < .001 && (h = 0), Math.abs(b) < .001 && (b = 0);
                        const w = `translate3d(${y}px,${v}px,${m}px)  rotateX(${u(h)}deg) rotateY(${u(f)}deg) scale(${b})`;
                        if (le(0, t).style.transform = w, t.style.zIndex = 1 - Math.abs(Math.round(p)), r.slideShadows) {
                            ...
                            e || (e = de("coverflow", t, o ? "left" : "top")), i || (i = de("coverflow", t, o ? "right" : "bottom")), e && (e.style.opacity = p > 0 ? p : 0), i && (i.style.opacity = -p > 0 ? -p : 0)
                        }
                    }
                },
                setTransition: e => {
            ...
            ae({
                ...
                setTranslate: () => {
                    ...
                    } = r, a = t.params.centeredSlides, l = T(t);
                    if (a) {
                    ...
                    for (let i = 0; i < e.length; i += 1) {
                        ...
                        let u = d;
                        a || (u = Math.min(Math.max(n.originalProgress, -r.limitProgress), r.limitProgress));
                        ...
                        d < 0 ? (g = r.next, m = !0) : d > 0 && (g = r.prev, m = !0), f.forEach((e, t) => {
                            f[t] = `calc(${e}px + (${s(g.translate[t])} * ${Math.abs(d*o)}))`
                        }), h.forEach((e, t) => {
                            let i = g.rotate[t] * Math.abs(d * o);
                            h[t] = i
                        }), n.style.zIndex = -Math.abs(Math.round(c)) + e.length;
                        const v = f.join(", "),
                            y = `rotateX(${l(h[0])}deg) rotateY(${l(h[1])}deg) rotateZ(${l(h[2])}deg)`,
                        ...
                        if (m && g.shadow || !m) {
                            ...
                            if (!e && g.shadow && (e = de("creative", n)), e) {
                                const t = r.shadowPerProgress ? d * (1 / r.limitProgress) : d;
                                e.style.opacity = Math.min(Math.max(Math.abs(t), 0), 1)
                            }
                        }
                        const _ = le(0, n);
                        _.style.transform = E, _.style.opacity = w, g.origin && (_.style.transformOrigin = g.origin)
                    }
                },
                setTransition: e => {
                    const i = t.slides.map(e => h(e));
                ...
                setTranslate: () => {
                    ...
                    for (let l = 0; l < e.length; l += 1) {
                        ...
                        const b = t.virtual && t.params.virtual.enabled ? t.virtual.from + l : l,
                            w = (b === i || b === i - 1) && u > 0 && u < 1 && (o || t.params.cssMode) && a < r,
                            E = (b === i || b === i + 1) && u < 0 && u > -1 && (o || t.params.cssMode) && a > r;
                        if (w || E) {
                            const e = (1 - Math.abs((Math.abs(u) - .5) / .5)) ** .5;
                            v += -28 * u * e, g += -.5 * e, y += 96 * e, h = -25 * e * Math.abs(u) + "%"
                        }
                        if (f = u < 0 ? `calc(${f}px ${n?"-":"+"} (${y*Math.abs(u)}%))` : u > 0 ? `calc(${f}px ${n?"-":"+"} (-${y*Math.abs(u)}%))` : f + "px", !t.isHorizontal()) {
                            const e = h;
                            h = f, f = e
                        }
                        ...
                        if (s.slideShadows) {
                            ...
                            e || (e = de("cards", c)), e && (e.style.opacity = Math.min(Math.max((Math.abs(u) - .5) / .5, 0), 1))
                        }
                        c.style.zIndex = -Math.abs(Math.round(d)) + e.length, le(0, c).style.transform = x
                    }
                },
                setTransition: e => {
                    const i = t.slides.map(e => h(e));
